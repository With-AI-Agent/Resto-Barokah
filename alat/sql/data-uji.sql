...
-- Perangkat TERDAFTAR (T1-24, migrasi 0018) — identitas sah untuk percobaan PIN di
-- berkas uji. Kunci tiap perangkat berpola 'kunci-uji-<nama>-0123456789' (>=16 karakter);
-- hash-nya dibuat di sini lewat jalur pemilik tabel (pola penyiapan data uji).
insert into public.perangkat (id, penyewa_id, cabang_id, nama, didaftarkan_oleh) values
  ('de000000-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', 'a1a1a1a1-0000-0000-0000-000000000001', 'hp-owner',   '90000000-0000-0000-0000-000000000002'),
  ('de000000-0000-0000-0000-000000000002', '11111111-1111-1111-1111-111111111111', 'a1a1a1a1-0000-0000-0000-000000000001', 'hp-admin',   '90000000-0000-0000-0000-000000000002'),
  ('de000000-0000-0000-0000-000000000003', '11111111-1111-1111-1111-111111111111', 'a1a1a1a1-0000-0000-0000-000000000001', 'hp-kasir',   '90000000-0000-0000-0000-000000000002'),
  ('de000000-0000-0000-0000-000000000004', '11111111-1111-1111-1111-111111111111', 'a1a1a1a1-0000-0000-0000-000000000001', 'hp-pelayan', '90000000-0000-0000-0000-000000000002'),
  ('de000000-0000-0000-0000-000000000005', '11111111-1111-1111-1111-111111111111', 'a1a1a1a1-0000-0000-0000-000000000002', 'hp-dapur',   '90000000-0000-0000-0000-000000000002'),
  ('de000000-0000-0000-0000-000000000006', '11111111-1111-1111-1111-111111111111', 'a1a1a1a1-0000-0000-0000-000000000001', 'hp-atasan',  '90000000-0000-0000-0000-000000000002'),
  ('de000000-0000-0000-0000-000000000007', '11111111-1111-1111-1111-111111111111', 'a1a1a1a1-0000-0000-0000-000000000001', 'hp-cadangan','90000000-0000-0000-0000-000000000002');
...
insert into public.perangkat (id, penyewa_id, cabang_id, nama, didaftarkan_oleh) values
  ('de000000-0000-0000-0000-000000000008', '22222222-2222-2222-2222-222222222222', 'b1b1b1b1-0000-0000-0000-000000000001', 'hp-b1', '90000000-0000-0000-0000-000000000007');
insert into public.kredensial_perangkat (perangkat_id, kunci_hash)
values ('de000000-0000-0000-0000-000000000008', crypt('kunci-uji-hp-b1-0123456789', gen_salt('bf', 10)));
