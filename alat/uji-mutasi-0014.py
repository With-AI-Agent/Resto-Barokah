...
DAFTAR = [
    ...
    # Targetkan nama trigger lama secara spesifik. Migrasi 0024 menambah constraint
    # trigger `item_beku_akhir_satu_pernyataan` dengan klausa AFTER yang sama; pola
    # generik akan memutasi pagar 0024 (yang tidak memanggil hitung_total) dan memberi
    # hijau palsu, sementara trigger efektif yang hendak dibuktikan adalah
    # `item_hitung_total` dari 0014.
