...
GERBANG_WAJIB = [
    ...
    ("bukti mutasi pagar buka shift 0045 (T7-01 modal awal & shift unik)",
    ...
    ("bukti mutasi pagar wajib shift 0048 (T7-04 transaksi hanya dalam shift terbuka)",
     r"python3 alat/uji-mutasi-0048.py"),
    ("bukti mutasi pagar pengingat shift 0049 (T7-05 pengingat belum ditutup)",
     r"python3 alat/uji-mutasi-0049.py"),
    ("bukti mutasi pagar koreksi modal 0050 (T7-06 koreksi modal awal izin atasan)",
     r"python3 alat/uji-mutasi-0050.py"),
    ("bukti mutasi pagar laporan kas 0051 (T7-07 laporan kas harian & per shift)",
     r"python3 alat/uji-mutasi-0051.py"),
    ("bukti mutasi pagar laporan penjualan 0052 (T7-08 laporan penjualan dasar)",
     r"python3 alat/uji-mutasi-0052.py"),
    ("bukti mutasi pagar laporan menu 0053 (T7-09 menu terlaris & diskon/voucher)",
    ...
    ("bukti mutasi pagar sesi_masih_aktif 0058 (N F-03 audit 2026-09-24 pencabutan sesi阻断)",
     r"python3 alat/uji-mutasi-0058.py"),
    ...
    ("bukti mutasi kunci serialisasi uang 0021 (F F-12)",
     r"python3 alat/uji-mutasi-0021.py"),
    ("bukti mutasi pembekuan setelah bayar 0022 (T-025a)",
     r"python3 alat/uji-mutasi-0022.py"),
    ("bukti mutasi pembekuan satu-pernyataan 0024 (G3 A-F03)",
     r"python3 alat/uji-mutasi-0024.py"),
    ("bukti mutasi isolasi identitas kosong 0025 (G3 A-F02)",
     r"python3 alat/uji-mutasi-0025.py"),
    ("bukti mutasi pemulihan perangkat 0028 (T1-36)",
     r"python3 alat/uji-mutasi-0028\.py"),
    ("bukti mutasi audit kekal & rantai hash 0029 (T1-13/T1-27)",
     r"python3 alat/uji-mutasi-0029\.py"),
    ("bukti mutasi sesi & pendaftaran perangkat 0030 (T1-24/T1-25/T1-26)",
     r"python3 alat/uji-mutasi-0030\.py"),
    ("bukti mutasi mode dukungan platform 0031 (T1-28)",
     r"python3 alat/uji-mutasi-0031\.py"),
    ("bukti mutasi status item dapur 0032 (T4-04)",
     r"python3 alat/uji-mutasi-0032\.py"),
    ("bukti mutasi tujuan item dapur/bar 0033 (T4-02)",
     r"python3 alat/uji-mutasi-0033\.py"),
    ("bukti mutasi menu habis sumber 0035 (T4-05)",
     r"python3 alat/uji-mutasi-0035\.py"),
    ("bukti mutasi set_stok 0036 (T4-06)",
    ...
    ("bukti mutasi bayar_pesanan 0039 (T5-02)", r"python3 alat/uji-mutasi-0039\.py"),
    ("bukti mutasi urutan rantai audit 0040", r"python3 alat/uji-mutasi-0040\.py"),
    ...
    ("uji concurrency nyata 2 koneksi (PostgreSQL pgserver)",
     r"python3 alat/uji-konkuren.py"),
    ("uji-diri klasifikasi concurrency (runtime bukan bukti)",
     r"python3 alat/uji-konkuren.py --uji-diri"),
    ("uji concurrency bayar versus edit/void 0022 (T-025a)",
     r"python3 alat/uji-konkuren-0022.py"),
    ("uji concurrency multi-baris rincian (A-F04)",
     r"python3 alat/uji-konkuren-a04.py"),
    ...
    ("uji-diri atribusi CI target (B-F08)", r"python3 alat/ci_target.py --uji-diri"),
    ("paritas perintah CI vs pemeriksaan lokal (B-F05)", r"python3 alat/periksa-paritas-ci.py"),
    ("uji-diri paritas CI vs lokal", r"python3 alat/periksa-paritas-ci.py --uji-diri"),
    ...
    ("pemeriksa kamus multi-bahasa (T1-40)", r"python3 aplikasi/alat/periksa-bahasa\.py"),
    ("uji-diri pemeriksa multi-bahasa", r"python3 aplikasi/alat/periksa-bahasa\.py --uji-diri"),
    ("pemeriksa arah & ukuran font (T1-41)", r"python3 aplikasi/alat/periksa-arah\.py"),
    ("uji-diri pemeriksa arah & font", r"python3 aplikasi/alat/periksa-arah\.py --uji-diri"),
    ("pemeriksa bantuan kontekstual (T1-42)", r"python3 alat/periksa-bantuan\.py"),
    ("uji-diri pemeriksa bantuan", r"python3 alat/periksa-bantuan\.py --uji-diri"),
    ("pemeriksa catatan audit (T1-13/T1-27)", r"python3 alat/periksa-audit\.py"),
    ("uji-diri pemeriksa catatan audit", r"python3 alat/periksa-audit\.py --uji-diri"),
    ("pemeriksa matriks izin 6 peran (T1-29)", r"python3 alat/periksa-matriks-izin\.py"),
    ("uji-diri pemeriksa matriks izin", r"python3 alat/periksa-matriks-izin\.py --uji-diri"),
...
PELEMAHAN = [
    ...
    (r"continue-on-error:\s*\$\{\{\s*true\s*\}\}", "langkah diberi ekspresi `continue-on-error: ${{ true }}` (gagal tidak memerahkan CI)"),
    (r"^\s*shell:\s*cat\s*\{0\}\s*$", "langkah memakai `shell: cat {0}` — isi perintah tidak dieksekusi sebagai shell gagal-terkendali"),
...
def uji_diri() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="gerbang-ci-") as tmp:
        ...
        mutasi("langkah bukti mutasi 0018 dihapus",
               lambda t: re.sub(r"\n\s*- name: Bukti mutasi pagar migrasi 0018[\s\S]*?run: python3 alat/uji-mutasi-0018\.py", "", t, count=1))
        mutasi("langkah papan maraton dihapus",
               lambda t: re.sub(r"\n\s*- name: Papan tugas maraton valid[\s\S]*?run: python3 alat/periksa-maraton\.py", "", t, count=1))
        ...
        mutasi("langkah diberi continue-on-error ekspresi", lambda t: t.replace("    runs-on: ubuntu-latest", "    runs-on: ubuntu-latest\n    continue-on-error: ${{ true }}", 1))
        mutasi("langkah memakai shell cat yang tidak menjalankan perintah", lambda t: t.replace(
