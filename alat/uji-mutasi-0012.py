...
DAFTAR = [
    ...
    # Penjaga "kupon PIN sekali pakai" untuk VOID ada di `picu_pembatalan_sah`. Berkasnya
    # DITULIS EKSPLISIT sejak 2026-09-23 karena pola `and pp.dipakai_pada is null` juga
    # muncul di pemicu lain (0016 persetujuan diskon, 0041 batas diskon), sehingga
    # pencarian "migrasi terbaru dulu" mengenai berkas SALAH dan M6 terbaca "pagar tumpul"
    # padahal pagar void tidak tersentuh — jebakan yang sama pernah memakan M5k (2026-09-19).
    #
    # Nama berkasnya WAJIB ikut berpindah setiap kali fungsi itu ditulis ulang: yang berlaku
    # saat pemasangan adalah definisi TERAKHIR. 0015 → 0042 (T5-07, penanda bahan terbuang);
    # memutasi 0015 setelah itu tidak berpengaruh apa-apa karena langsung ditimpa 0042.
    ("M6 bukti PIN boleh dipakai berulang",
     "       and pp.dipakai_pada is null", "       and (pp.dipakai_pada is null or true)",
     "supabase/tes/persetujuan_void.sql", "0042_bahan_terbuang_jujur.sql"),
