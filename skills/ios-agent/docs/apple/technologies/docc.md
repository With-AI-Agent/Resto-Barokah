...
Load this when a task names **DocC** or one of the API topics below.
...
Apple routes this entry to an external resource: [verified destination](https://www.swift.org/documentation/docc/). No DocC symbol inventory is claimed for this entry.
