...
Load this when a task names **CareKit** or one of the API topics below.
...
Apple routes this entry to an external resource: [verified destination](https://carekit-apple.github.io/CareKit/documentation/carekit/). No DocC symbol inventory is claimed for this entry.
