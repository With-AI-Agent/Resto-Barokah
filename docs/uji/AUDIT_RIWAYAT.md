...
6. **Sesi ketiga tidak mengirim laporan** (tidak ada cabang `arena/*` ketiga). Dua laporan yang masuk sudah cukup untuk bertindak: keduanya sepakat pada cacat terberat (uang lebih bayar, PIN, jejak pelaku), dan kesepakatan itu diverifikasi ulang oleh mesin.
