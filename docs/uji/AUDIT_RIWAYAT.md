...
**Catatan editorial (2026-09-19):** saat kunci kalibrasi dikeluarkan dari repo (D F-05), jalur berkas lama docs/uji/kalibrasi/pr-bahan-2026-09-17.diff ditulis **tanpa backtick** (provenance) di seluruh berkas riwayat, paket, dan laporan yang menyebutnya — perbaikan mekanis supaya validator salinan bersih (AT-08) tidak membaca rujukan menggantung; tidak ada satu pun angka, verdict, atau temuan yang diubah.
