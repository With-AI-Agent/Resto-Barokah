...
|---|---|---|---|---|
| H F-01 | K-2 | Kunci jawaban kalibrasi cacat tanaman masih bisa dibaca dari dalam repo — penutupan D F-05 belum tuntas | **TERBUKA** | bantah-balik dulu: apakah katalog cacat (`alat/kalibrasi-cacat.json`) + jalur `bahan_bocor_di_repo` cukup bagi auditor yang membaca repo untuk menebak jawaban → `T1-44` |
