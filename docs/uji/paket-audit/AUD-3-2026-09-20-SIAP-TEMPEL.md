...
# PAKET AUDIT INDEPENDEN — AUD-3 — 2026-09-20
...
- **Tingkat audit:** AUD-3
- **Commit yang diaudit:** `cbba40108fa17eca39a438cd25588f23807873fd` (commit tepat sebelum berkas paket ini dibuat; auditor boleh mencatat commit yang benar-benar ia periksa — tulis apa adanya, jangan dibulatkan ke commit lain)
- **CI commit target:** success (run 35518950919) — diperiksa mesin terhadap commit `cbba40108fa17eca39a438cd25588f23807873fd`
...
Paket ini menargetkan commit **`cbba40108fa17eca39a438cd25588f23807873fd`** pada cabang **`arena/01a0b7d1-resto-barokah`**. **Cabang/base apa pun yang Lee pilih tidak masalah** —
...
> git checkout --detach cbba40108fa17eca39a438cd25588f23807873fd
> ```
...
git cat-file -e cbba40108fa17eca39a438cd25588f23807873fd            # apakah commit target ada di repo ini?
```

- **Sama** (`HEAD` = `cbba40108fa17eca39a438cd25588f23807873fd`) → langsung lanjut.
- **Berbeda tetapi commit target ada** → pindah hanya-baca lalu lanjut (aman, tidak mengubah apa pun):
  `git fetch origin && git checkout --detach cbba40108fa17eca39a438cd25588f23807873fd`
...
```
docs/uji/audit/LAPORAN_AUD-3_2026-09-20_menyeluruh__<penanda-sesi>.md
```
...
- **Jumlah berkas dalam lingkup:** 522
...
| aplikasi/alat | perkakas pemeriksa aplikasi | 12 | `aplikasi/alat/catat-alamat.mjs`, `aplikasi/alat/cek-supabase.mjs` … |
| aplikasi (konfigurasi) | package.json, tsconfig, vite, index.html | 17 | `aplikasi/.env.example`, `aplikasi/.gitignore` … |
| supabase/migrations | migrasi database | 17 | `supabase/migrations/.gitkeep`, `supabase/migrations/0001_penyewa_cabang.sql` … |
| supabase/tes | uji SQL | 59 | `supabase/tes/.gitkeep`, `supabase/tes/cabang_sesi.sql` … |
...
| alat | perkakas repo (uji SQL, pemeriksa, mekanisme audit) | 48 | `alat/artefak.py`, `alat/audit-independen.py` … |
...
| docs/uji | protokol & laporan uji/audit | 110 | `docs/uji/AUDIT_RIWAYAT.md`, `docs/uji/BERKAS_PENSIUN.md` … |
...
2. Tulis ringkasan: `Cakupan menyeluruh: X dari 522 berkas` (X = berkas yang benar-benar kamu periksa — angka ini diperiksa mesin).
...
| 73 | `supabase/migrations/0014_penutup_celah_putaran13.sql` |
| 74 | `supabase/tes/urutan_uang.sql` |
| 75 | `supabase/tes/gerbang_uang.sql` |
| 76 | `supabase/tes/diskon_voucher.sql` |
| 77 | `docs/KEAMANAN.md` |
| 78 | `docs/DECISIONS_LOG.md` |
| 79 | `supabase/migrations/0011_peran_tunggal.sql` |
| 80 | `supabase/tes/peran_tunggal.sql` |
| 81 | `supabase/tes/kredensial_pin.sql` |
| 82 | `supabase/tes/pin_batas_pasang.sql` |
| 83 | `alat/periksa-rahasia.py` |
| 84 | `docs/SPESIFIKASI_UI.md` |
| 85 | `docs/AGENT_OPERATING_GUIDE.md` |
| 86 | `docs/uji/DAFTAR_PEKERJAAN_ULANG.md` |
| 87 | `alat/sql/data-uji.sql` |
| 88 | `docs/uji/BUKU_UJI_PEMILIK.md` |
| 89 | `alat/periksa-buku-uji.py` |
| 90 | `alat/audit-independen.py` |
| 91 | `docs/uji/TEMUAN_LUAR_CAKUPAN_REVIEW.md` |
| 92 | `supabase/migrations/0015_penutup_celah_putaran16.sql` |
| 93 | `alat/lanjut-sesi.py` |
| 94 | `alat/periksa-temuan-audit.py` |
| 95 | `aplikasi/alat/uji-mutasi-app.mjs` |
| 96 | `aplikasi/package-lock.json` |
| 97 | `aplikasi/alat/periksa-node.py` |
| 98 | `alat/uji-edge-pin.mjs` |
| 99 | `alat/artefak.py` |
| 100 | `alat/klasifikasi_mutasi.py` |
| 101 | `alat/ci_target.py` |
| 102 | `alat/periksa-paket.py` |
| 103 | `docs/uji/BERKAS_PENSIUN.md` |
| 104 | `alat/periksa-kunci-kalibrasi.py` |
| 105 | `alat/periksa-rujukan.py` |
| 106 | `docs/uji/audit/probe-2026-09-20/aud-3-f10-admin-cabang-izin.sql` |
| 107 | `docs/TECH_SPEC.md` |
| 108 | `docs/PRD.md` |
| 109 | `docs/uji/audit/probe-2026-09-20/aud-3-f11-helper-pin.sql` |
| 110 | `supabase/tes/pin_helper_pribadi.sql` |
| 111 | `supabase/tes/nomor_pesanan_kunci.sql` |
| 112 | `alat/uji-mutasi-0015.py` |
| 113 | `docs/uji/audit/probe-2026-09-20/aud-3-f04-status-item.sql` |
| 114 | `supabase/tes/status_item_transisi.sql` |
| 115 | `supabase/tes/uang_peladen.sql` |
| 116 | `docs/uji/audit/probe-2026-09-20/aud-3-f03-f05-f06-uang.sql` |
| 117 | `supabase/tes/metode_bayar_nonaktif.sql` |
| 118 | `supabase/tes/pembatalan_sekali.sql` |
| 119 | `supabase/tes/lifecycle_pesanan.sql` |
| 120 | `docs/uji/audit/LAPORAN_AUD-3_2026-09-19_menyeluruh__01a0bbd2.md` |
| 121 | `docs/uji/audit/probe-2026-09-20/aud-3-f01-f02-uang.sql` |
| 122 | `supabase/tes/nomor_pesanan_isolasi.sql` |
| 123 | `supabase/tes/pin_bukan_oracle.sql` |
| 124 | `supabase/tes/diskon_sesudah_lunas.sql` |
| 125 | `supabase/tes/void_satu_item.sql` |
| 126 | `supabase/tes/pembatalan_penanda_palsu.sql` |
| 127 | `aplikasi/src/App.tsx` |
| 128 | `aplikasi/src/komponen/Keadaan*.tsx` |
| 129 | `prototipe/README.md` |
| 130 | `docs/teknis/BUKU_INSIDEN.md` |
| 131 | `alat/periksa-angka-bukti.py` |
| 132 | `supabase/tes/cabang_sesi.sql` |
| 133 | `supabase/tes/diskon_cap.sql` |
| 134 | `supabase/tes/diskon_cap_bawaan.sql` |
| 135 | `supabase/tes/diskon_persen.sql` |
| 136 | `supabase/tes/diskon_setuju.sql` |
| 137 | `supabase/tes/hak_fungsi.sql` |
| 138 | `supabase/tes/harga_item.sql` |
| 139 | `supabase/tes/isolasi_lintas_penyewa.sql` |
| 140 | `supabase/tes/item_penjaga.sql` |
| 141 | `supabase/tes/izin_efektif_untuk.sql` |
| 142 | `supabase/tes/jejak_pelaku.sql` |
| 143 | `supabase/tes/jejak_pengaturan.sql` |
| 144 | `supabase/tes/jejak_pesanan.sql` |
| 145 | `supabase/tes/kupon_wajib_pesanan.sql` |
| 146 | `supabase/tes/meja_penjaga.sql` |
| 147 | `supabase/tes/meja_riwayat.sql` |
| 148 | `supabase/tes/nilai_kerugian.sql` |
| 149 | `supabase/tes/pembayaran_metode.sql` |
| 150 | `supabase/tes/penjaga_stok.sql` |
| 151 | `supabase/tes/persetujuan_void.sql` |
| 152 | `supabase/tes/pesanan_status_awal.sql` |
| 153 | `supabase/tes/pin_hierarki.sql` |
| 154 | `supabase/tes/pin_kunci_silang.sql` |
| 155 | `supabase/tes/pin_warisan.sql` |
| 156 | `supabase/tes/saldo_awal_stok.sql` |
| 157 | `supabase/tes/status_pesanan.sql` |
| 158 | `supabase/tes/stok_arah.sql` |
| 159 | `supabase/tes/stok_insert_langsung.sql` |
| 160 | `supabase/tes/varian_gagal_aman.sql` |
| 161 | `alat/bantu_uji_diri.py` |
| 162 | `alat/mulai-sesi.py` |
| 163 | `alat/periksa-bersih.py` |
| 164 | `alat/periksa-fondasi-independen.py` |
| 165 | `alat/siapkan-pemeriksaan.py` |
| 166 | `alat/uji-mutasi-0012.py` |
| 167 | `alat/uji-mutasi-0014.py` |
| 168 | `alat/uji-mutasi-0016.py` |
...
| 9 | `python3 alat/uji-mutasi-0015.py  →  alat/uji-mutasi-0015.py` |
