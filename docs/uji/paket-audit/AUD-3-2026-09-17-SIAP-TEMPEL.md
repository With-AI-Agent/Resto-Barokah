...
- **Tingkat audit:** AUD-3
- **Commit yang diaudit:** `85321ca4df749b1d81ee2c3ed477ca55c0cfec88`
...
- **Jumlah berkas dalam lingkup:** 319
...
| docs/uji | protokol & laporan uji/audit | 17 | `docs/uji/AUDIT_RIWAYAT.md`, `docs/uji/CATATAN_REVIEW_SESI_01a0aab1.md` … |
...
2. Tulis ringkasan: `Cakupan menyeluruh: X dari 319 berkas` (X = berkas yang benar-benar kamu periksa; angka ini diperiksa mesin).
