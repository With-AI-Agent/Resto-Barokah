...
# PAKET AUDIT INDEPENDEN — AUD-3 — 2026-09-24
...
- **Tingkat audit:** AUD-3
- **Commit yang diaudit:** `e7818e2f8c51d4b6503ce6becd1cbc3b7d11be6b` (commit tepat sebelum berkas paket ini dibuat; auditor boleh mencatat commit yang benar-benar ia periksa — tulis apa adanya, jangan dibulatkan ke commit lain)
- **CI commit target:** BELUM-HIJAU (BELUM HIJAU — 1 run CI pada commit itu: failure)
- **Izin pemilik untuk commit non-hijau:** fase 7 tuntas, CI c51ada6 100% hijau
...
- **Minimum laporan:** ≥18 artefak diperiksa · ≥5 klaim dibantah · ≥12 serangan dijalankan · masing-masing temuan punya perintah bukti
...
Paket ini menargetkan commit **`e7818e2f8c51d4b6503ce6becd1cbc3b7d11be6b`** pada cabang **`arena/01a0d09b-resto-barokah`**. **Cabang/base apa pun yang Lee pilih tidak masalah** —
...
```sh
git fetch --no-write-fetch-head origin e7818e2f8c51d4b6503ce6becd1cbc3b7d11be6b
TARGET="$(mktemp -d)"
git archive e7818e2f8c51d4b6503ce6becd1cbc3b7d11be6b | tar -x -C "$TARGET"
```
...
- **Jumlah berkas dalam lingkup:** 839
- **Mode cakupan yang wajib kamu tulis di laporan:** `menyeluruh`
- **Sumber angka:** pohon commit `e7818e2f8c51d4b6503ce6becd1cbc3b7d11be6b` (`git ls-tree -r --name-only`), BUKAN meja kerja — berkas yang belum di-commit TIDAK masuk hitungan (B F-16).
- **Berkas paket ini:** `docs/uji/paket-audit/AUD-3-2026-09-24.md` dibuat SETELAH angka di atas dihitung — ia TIDAK masuk hitungan; kalau dihitung pun ia masuk grup `docs/uji`.

**Grup berkas yang wajib kamu sentuh (minimal satu baris bukti per grup):**

| Grup | Isi | Jumlah berkas | Contoh |
|---|---|---|---|
| aplikasi/src | kode aplikasi (layar, komponen, lib, uji) | 219 | `aplikasi/src/App.tsx`, `aplikasi/src/bahasa/ar.ts` … |
| aplikasi/alat | perkakas pemeriksa aplikasi | 14 | `aplikasi/alat/catat-alamat.mjs`, `aplikasi/alat/cek-supabase.mjs` … |
| aplikasi (konfigurasi) | package.json, tsconfig, vite, index.html | 20 | `aplikasi/.env.example`, `aplikasi/.gitignore` … |
| supabase/migrations | migrasi database | 53 | `supabase/migrations/.gitkeep`, `supabase/migrations/0001_penyewa_cabang.sql` … |
| supabase/tes | uji SQL | 99 | `supabase/tes/.gitkeep`, `supabase/tes/anti_dobel.sql` … |
...
| alat | perkakas repo (uji SQL, pemeriksa, mekanisme audit) | 96 | `alat/artefak.py`, `alat/audit-independen.py` … |
...
| docs (fondasi) | PRD, TECH_SPEC, ROADMAP, KEAMANAN, SPESIFIKASI_UI, dll | 15 | `docs/AGENT_OPERATING_GUIDE.md`, `docs/DECISIONS_LOG.md` … |
| docs/uji | protokol & laporan uji/audit | 132 | `docs/uji/AUDIT_RIWAYAT.md`, `docs/uji/BERKAS_PENSIUN.md` … |
| docs/teknis | catatan teknis & Buku Insiden | 6 | `docs/teknis/BUKU_INSIDEN.md`, `docs/teknis/DISKUSI_TAHAP4_ATURAN_KERJA.md` … |
| docs/ops | panduan operasional | 13 | `docs/ops/ALAMAT_PUBLIK.md`, `docs/ops/DAFTAR_KUNCI_PEMILIK.template.md` … |
...
| _log-sesi | log sesi kerja | 14 | `_log-sesi/LOG_SESI_2026-09-15.md`, `_log-sesi/LOG_SESI_2026-09-16.md` … |
| berkas pengguna di akar | PANDUAN_*, PROMPT_*, START_DI_SINI, PROFIL_PENGGUNA, AGENT_SYSTEM, STATUS, PROJECT_STATE, dll | 19 | `.gitignore`, `10_LOG_SESI.md` … |
...
2. Tulis ringkasan: `Cakupan menyeluruh: X dari 839 berkas` (X = berkas yang benar-benar kamu periksa — angka ini diperiksa mesin).
...
| 18 | `aplikasi/src/lib/env.ts` |
| 19 | `aplikasi/README.md` |
| 20 | `.github/workflows/ci.yml` |
| 21 | `aplikasi/src/lib/supabase.ts` |
| 22 | `aplikasi/src/lib/supabase.test.ts` |
| 23 | `aplikasi/alat/cek-supabase.mjs` |
| 24 | `.github/workflows/sebar-skema.yml` |
| 25 | `docs/ops/LANGKAH_PEMILIK_SEKARANG.md` |
| 26 | `alat/periksa-gerbang-ci.py` |
| 27 | `alat/periksa-migrasi-beku.py` |
| 28 | `docs/ops/ALAMAT_PUBLIK.md` |
| 29 | `.github/workflows/sebar-halaman.yml` |
| 30 | `aplikasi/src/lib/format.test.ts` |
| 31 | `aplikasi/src/lib/tema.test.ts` |
| 32 | `aplikasi/src/lib/env.test.ts` |
| 33 | `aplikasi/src/hook/useJam.test.tsx` |
| 34 | `aplikasi/src/hook/useTema.test.tsx` |
| 35 | `aplikasi/src/komponen/komponen.test.tsx` |
| 36 | `aplikasi/alat/periksa-uji.py` |
| 37 | `alat/periksa-roadmap.py` |
| 38 | `docs/uji/PROTOKOL_AUDIT_INDEPENDEN.md` |
| 39 | `alat/periksa-panduan.py` |
| 40 | `docs/PANDUAN_PEMILIK.md` |
| 41 | `docs/uji/PROMPT_AUDIT_INDEPENDEN.md` |
| 42 | `docs/ROADMAP.md` |
| 43 | `docs/uji/AUDIT_RIWAYAT.md` |
| 44 | `docs/TERTANGGUH.md` |
| 45 | `docs/uji/PROTOKOL_REVIEW_PR_INDEPENDEN.md` |
| 46 | `docs/uji/PROMPT_REVIEW_PR_INDEPENDEN.md` |
| 47 | `alat/review-pr.py` |
| 48 | `docs/uji/REVIEW_PR_RIWAYAT.md` |
| 49 | `docs/teknis/REKAM_PESAN_PEMILIK.md` |
| 50 | `supabase/migrations/0001_penyewa_cabang.sql` |
| 51 | `supabase/tes/rls_penyewa.sql` |
| 52 | `supabase/migrations/0002_pengguna_izin_pengaturan.sql` |
| 53 | `supabase/tes/rls_pengguna.sql` |
| 54 | `supabase/migrations/0003_helper_identitas.sql` |
| 55 | `supabase/tes/helper.sql` |
| 56 | `supabase/migrations/0004_pola_rls.sql` |
| 57 | `supabase/tes/rls_semua_tabel.sql` |
| 58 | `supabase/migrations/0005_izin_berjenjang.sql` |
| 59 | `supabase/tes/izin.sql` |
| 60 | `supabase/migrations/0006_pin.sql` |
| 61 | `supabase/functions/verifikasi_pin/index.ts` |
| 62 | `supabase/tes/pin.sql` |
| 63 | `supabase/tes/percobaan_pin_perangkat.sql` |
| 64 | `alat/periksa-fungsi-pin.py` |
| 65 | `supabase/migrations/0007_katalog.sql` |
| 66 | `supabase/tes/katalog.sql` |
| 67 | `supabase/migrations/0008_meja.sql` |
| 68 | `supabase/tes/meja.sql` |
| 69 | `supabase/migrations/0009_pesanan.sql` |
| 70 | `supabase/tes/pesanan.sql` |
| 71 | `supabase/migrations/0010_pembayaran.sql` |
| 72 | `supabase/tes/pembayaran.sql` |
| 73 | `supabase/migrations/0020_catatan_audit.sql` |
| 74 | `supabase/migrations/0029_audit_kekal_rantai.sql` |
| 75 | `supabase/tes/catatan_audit.sql` |
| 76 | `supabase/tes/audit_rantai.sql` |
| 77 | `alat/uji-mutasi-0029.py` |
| 78 | `supabase/migrations/0014_penutup_celah_putaran13.sql` |
| 79 | `supabase/tes/urutan_uang.sql` |
| 80 | `supabase/tes/gerbang_uang.sql` |
| 81 | `supabase/tes/diskon_voucher.sql` |
| 82 | `alat/uji-mutasi-0009.py` |
| 83 | `docs/DECISIONS_LOG.md` |
| 84 | `docs/KEAMANAN.md` |
| 85 | `supabase/migrations/0011_peran_tunggal.sql` |
| 86 | `supabase/tes/peran_tunggal.sql` |
| 87 | `supabase/tes/kredensial_pin.sql` |
| 88 | `supabase/tes/pin_batas_pasang.sql` |
| 89 | `supabase/migrations/0018_perangkat_terdaftar.sql` |
| 90 | `supabase/migrations/0030_sesi_dan_persetujuan_perangkat.sql` |
| 91 | `supabase/tes/perangkat_registrasi.sql` |
| 92 | `supabase/tes/sesi_dan_perangkat.sql` |
| 93 | `alat/uji-mutasi-0030.py` |
| 94 | `alat/periksa-audit.py` |
| 95 | `supabase/migrations/0031_mode_dukungan_platform.sql` |
| 96 | `supabase/tes/mode_dukungan.sql` |
| 97 | `alat/uji-mutasi-0031.py` |
| 98 | `supabase/tes/matriks_izin_6_peran.sql` |
| 99 | `alat/periksa-matriks-izin.py` |
| 100 | `docs/uji/TINDAK_LANJUT_AUD2_2026-09-21.md` |
| 101 | `alat/periksa-keamanan-sql.py` |
| 102 | `alat/periksa-rahasia.py` |
| 103 | `supabase/tes/keamanan_fungsi.sql` |
| 104 | `supabase/migrations/0023_acl_fungsi_pemicu.sql` |
| 105 | `supabase/migrations/0027_initplan_policy_rls.sql` |
| 106 | `docs/uji/BUKTI_T130_KEAMANAN_SQL.md` |
| 107 | `aplikasi/src/lib/layar.ts` |
| 108 | `docs/SPESIFIKASI_UI.md` |
| 109 | `docs/PETA_UI.md` |
| 110 | `alat/peta-ui.py` |
| 111 | `aplikasi/src/lib/aksi.ts` |
| 112 | `aplikasi/src/komponen/TombolAksi.tsx` |
| 113 | `aplikasi/src/komponen/TombolAksi.test.tsx` |
| 114 | `aplikasi/src/uji/harness.tsx` |
| 115 | `aplikasi/src/uji/harness.test.tsx` |
| 116 | `docs/AGENT_OPERATING_GUIDE.md` |
| 117 | `docs/uji/NASKAH_JALAN.md` |
| 118 | `supabase/migrations/0028_pemulihan_perangkat.sql` |
| 119 | `supabase/tes/pemulihan.sql` |
| 120 | `docs/ops/PEMULIHAN_PERANGKAT.md` |
| 121 | `alat/uji-mutasi-0028.py` |
| 122 | `docs/uji/DAFTAR_PEKERJAAN_ULANG.md` |
| 123 | `alat/sql/data-uji.sql` |
| 124 | `aplikasi/src/bahasa/id.ts` |
| 125 | `aplikasi/src/bahasa/index.tsx` |
| 126 | `aplikasi/alat/periksa-bahasa.py` |
| 127 | `aplikasi/alat/periksa-arah.py` |
| 128 | `aplikasi/src/kontrak/bantuan.ts` |
| 129 | `aplikasi/src/komponen/LembarBantuan.tsx` |
| 130 | `alat/periksa-bantuan.py` |
| 131 | `docs/uji/BUKU_UJI_PEMILIK.md` |
| 132 | `alat/periksa-buku-uji.py` |
| 133 | `alat/tambah-uji.py` |
| 134 | `alat/audit-independen.py` |
| 135 | `alat/periksa-paket.py` |
| 136 | `supabase/migrations/0022_beku_setelah_bayar.sql` |
| 137 | `alat/uji-mutasi-0022.py` |
| 138 | `alat/uji-mutasi-0024.py` |
| 139 | `alat/uji-mutasi-0025.py` |
| 140 | `alat/uji-konkuren-0022.py` |
| 141 | `alat/uji-konkuren-a04.py` |
| 142 | `docs/uji/TEMUAN_LUAR_CAKUPAN_REVIEW.md` |
| 143 | `supabase/migrations/0015_penutup_celah_putaran16.sql` |
| 144 | `alat/lanjut-sesi.py` |
| 145 | `alat/periksa-temuan-audit.py` |
| 146 | `aplikasi/alat/uji-mutasi-app.mjs` |
| 147 | `aplikasi/package-lock.json` |
| 148 | `aplikasi/alat/periksa-node.py` |
| 149 | `alat/uji-edge-pin.mjs` |
| 150 | `alat/artefak.py` |
| 151 | `alat/klasifikasi_mutasi.py` |
| 152 | `alat/ci_target.py` |
| 153 | `docs/uji/BERKAS_PENSIUN.md` |
| 154 | `alat/periksa-kunci-kalibrasi.py` |
| 155 | `alat/periksa-rujukan.py` |
| 156 | `docs/uji/audit/probe-2026-09-20/aud-3-f10-admin-cabang-izin.sql` |
| 157 | `docs/TECH_SPEC.md` |
| 158 | `docs/PRD.md` |
| 159 | `docs/uji/audit/probe-2026-09-20/aud-3-f11-helper-pin.sql` |
| 160 | `supabase/tes/pin_helper_pribadi.sql` |
| 161 | `supabase/tes/nomor_pesanan_kunci.sql` |
| 162 | `alat/uji-mutasi-0015.py` |
| 163 | `docs/uji/audit/probe-2026-09-20/aud-3-f04-status-item.sql` |
| 164 | `supabase/tes/status_item_transisi.sql` |
| 165 | `supabase/tes/uang_peladen.sql` |
| 166 | `docs/uji/audit/probe-2026-09-20/aud-3-f03-f05-f06-uang.sql` |
| 167 | `supabase/tes/metode_bayar_nonaktif.sql` |
| 168 | `supabase/tes/pembatalan_sekali.sql` |
| 169 | `supabase/tes/lifecycle_pesanan.sql` |
| 170 | `docs/uji/audit/LAPORAN_AUD-3_2026-09-19_menyeluruh__01a0bbd2.md` |
| 171 | `docs/uji/audit/probe-2026-09-20/aud-3-f01-f02-uang.sql` |
| 172 | `supabase/tes/nomor_pesanan_isolasi.sql` |
| 173 | `supabase/tes/pin_bukan_oracle.sql` |
| 174 | `supabase/tes/diskon_sesudah_lunas.sql` |
| 175 | `supabase/tes/void_satu_item.sql` |
| 176 | `supabase/tes/pembatalan_penanda_palsu.sql` |
| 177 | `alat/uji-konkuren.py` |
| 178 | `aplikasi/src/lib/auth.ts` |
| 179 | `aplikasi/src/hook/useSesi.ts` |
| 180 | `aplikasi/src/lib/auth.test.ts` |
| 181 | `aplikasi/src/hook/useSesi.test.tsx` |
| 182 | `aplikasi/src/layar/masuk/LayarMasukPegawai.tsx` |
| 183 | `aplikasi/src/layar/masuk/LayarMasukPegawai.test.tsx` |
| 184 | `aplikasi/src/layar/pengaturan/KelolaPegawai.tsx` |
| 185 | `aplikasi/src/layar/pengaturan/KelolaPegawai.test.tsx` |
| 186 | `aplikasi/src/layar/masuk/LayarMasukPelanggan.tsx` |
| 187 | `aplikasi/src/layar/masuk/LayarMasukPelanggan.test.tsx` |
| 188 | `aplikasi/src/layar/masuk/LupaAkses.tsx` |
| 189 | `aplikasi/src/layar/masuk/LupaAkses.test.tsx` |
| 190 | `aplikasi/src/App.tsx` |
| 191 | `aplikasi/src/komponen/Rangka.tsx` |
| 192 | `aplikasi/src/komponen/Navigasi.tsx` |
| 193 | `aplikasi/src/komponen/Rangka.test.tsx` |
| 194 | `aplikasi/src/komponen/Navigasi.test.tsx` |
| 195 | `aplikasi/src/hook/useCabang.ts` |
| 196 | `aplikasi/src/komponen/PemilihCabang.tsx` |
| 197 | `aplikasi/src/hook/useCabang.test.tsx` |
| 198 | `aplikasi/src/komponen/PemilihCabang.test.tsx` |
| 199 | `aplikasi/src/layar/TidakPunyaAkses.tsx` |
| 200 | `aplikasi/src/lib/pesan.ts` |
| 201 | `aplikasi/src/layar/TidakPunyaAkses.test.tsx` |
| 202 | `aplikasi/src/lib/pesan.test.ts` |
| 203 | `aplikasi/src/hook/useKunciOtomatis.ts` |
| 204 | `aplikasi/src/hook/useKunciOtomatis.test.tsx` |
| 205 | `aplikasi/src/main.tsx` |
| 206 | `aplikasi/src/layar/masuk/SkenarioMasukPeran.test.tsx` |
| 207 | `aplikasi/src/layar/masuk/MasukPengelola.tsx` |
| 208 | `aplikasi/src/layar/masuk/MasukPengelola.test.tsx` |
| 209 | `aplikasi/src/layar/masuk/MasukStaf.tsx` |
| 210 | `aplikasi/src/layar/masuk/MasukStaf.test.tsx` |
| 211 | `aplikasi/src/layar/pengaturan/Perangkat.tsx` |
| 212 | `aplikasi/src/layar/pengaturan/Perangkat.test.tsx` |
| 213 | `aplikasi/src/komponen/KunciSekarang.tsx` |
| 214 | `aplikasi/src/komponen/KunciSekarang.test.tsx` |
| 215 | `aplikasi/src/layar/pengaturan/DaftarPerangkat.tsx` |
| 216 | `aplikasi/src/layar/pengaturan/DaftarPerangkat.test.tsx` |
| 217 | `aplikasi/src/layar/kasir/LayarKasir.tsx` |
| 218 | `aplikasi/src/layar/kasir/Katalog.tsx` |
| 219 | `aplikasi/src/layar/kasir/Keranjang.tsx` |
| 220 | `aplikasi/src/layar/kasir/PemilihMeja.tsx` |
| 221 | `aplikasi/src/layar/kasir/DaftarTagihan.tsx` |
| 222 | `aplikasi/src/layar/pelayan/LayarPelayan.tsx` |
| 223 | `aplikasi/src/layar/kasir/DaftarPesanan.tsx` |
| 224 | `aplikasi/src/layar/kasir/*.tsx` |
| 225 | `aplikasi/src/komponen/Keadaan*.tsx` |
| 226 | `aplikasi/src/layar/dapur/LayarDapur.tsx` |
| 227 | `aplikasi/src/layar/dapur/LayarBar.tsx` |
| 228 | `supabase/migrations/0033_tujuan_item.sql` |
| 229 | `aplikasi/src/layar/dapur/KartuPesanan.tsx` |
| 230 | `supabase/tes/status_item.sql` |
| 231 | `supabase/tes/menu_habis_sumber.sql` |
| 232 | `aplikasi/src/layar/dapur/TombolHabis.tsx` |
| 233 | `supabase/migrations/0035_menu_habis_sumber.sql` |
| 234 | `aplikasi/src/layar/dapur/Stok.tsx` |
| 235 | `supabase/migrations/0036_stok.sql` |
| 236 | `aplikasi/src/layar/dapur/Opname.tsx` |
| 237 | `supabase/migrations/0037_opname.sql` |
| 238 | `supabase/tes/anti_dobel.sql` |
| 239 | `aplikasi/src/layar/dapur/*.tsx` |
| 240 | `aplikasi/src/layar/kasir/Bayar.tsx` |
| 241 | `aplikasi/src/hook/useBayar.ts` |
| 242 | `aplikasi/src/layar/kasir/Bayar.test.tsx` |
| 243 | `aplikasi/src/hook/useBayar.test.tsx` |
| 244 | `aplikasi/src/layar/kasir/LayarKasirBayar.test.tsx` |
| 245 | `supabase/migrations/0039_bayar_pesanan.sql` |
| 246 | `supabase/tes/bayar_pesanan.sql` |
| 247 | `alat/uji-mutasi-0039.py` |
| 248 | `aplikasi/src/komponen/Struk.tsx` |
| 249 | `aplikasi/src/komponen/Struk.test.tsx` |
| 250 | `supabase/tes/pajak_service.sql` |
| 251 | `supabase/migrations/0019_pesan_diskon_jujur.sql` |
| 252 | `supabase/tes/diskon_tumpuk.sql` |
| 253 | `alat/uji-mutasi-0019.py` |
| 254 | `aplikasi/src/layar/kasir/DiskonManual.tsx` |
| 255 | `supabase/migrations/0041_diskon_pin_atasan.sql` |
| 256 | `supabase/tes/diskon_pin_atasan.sql` |
| 257 | `alat/uji-mutasi-0041.py` |
| 258 | `aplikasi/src/layar/kasir/LayarKasirDiskon.test.tsx` |
| 259 | `aplikasi/src/layar/kasir/VoidItem.tsx` |
| 260 | `supabase/migrations/0042_bahan_terbuang_jujur.sql` |
| 261 | `supabase/tes/bahan_terbuang.sql` |
| 262 | `alat/uji-mutasi-0042.py` |
| 263 | `aplikasi/src/layar/kasir/DataPelanggan.tsx` |
| 264 | `aplikasi/src/komponen/StrukDigital.tsx` |
| 265 | `aplikasi/src/layar/kasir/DaftarTransaksi.tsx` |
| 266 | `supabase/tes/pembayaran_sebagian.sql` |
| 267 | `supabase/migrations/0043_laporan_pembatalan.sql` |
| 268 | `aplikasi/src/layar/laporan/DaftarPembatalan.tsx` |
| 269 | `alat/uji-mutasi-0043.py` |
| 270 | `aplikasi/src/lib/printer/expos.ts` |
| 271 | `aplikasi/src/lib/printer/expos.test.ts` |
| 272 | `aplikasi/src/layar/pengaturan/PasangPrinter.tsx` |
| 273 | `aplikasi/src/lib/printer/profil.ts` |
| 274 | `aplikasi/src/lib/printer/kirim.ts` |
| 275 | `aplikasi/src/lib/printer/struk.ts` |
| 276 | `aplikasi/src/lib/printer/tiket.ts` |
| 277 | `supabase/migrations/0045_buka_shift.sql` |
| 278 | `aplikasi/src/layar/kasir/BukaKas.tsx` |
| 279 | `supabase/migrations/0046_tutup_shift.sql` |
| 280 | `aplikasi/src/layar/kasir/TutupKas.tsx` |
| 281 | `supabase/migrations/0047_kas_pergerakan.sql` |
| 282 | `aplikasi/src/layar/kasir/KasKeluarMasuk.tsx` |
| 283 | `supabase/migrations/0048_wajib_shift.sql` |
| 284 | `supabase/tes/wajib_shift.sql` |
| 285 | `aplikasi/src/komponen/PengingatShift.tsx` |
| 286 | `supabase/migrations/0049_pengingat_shift.sql` |
| 287 | `supabase/migrations/0050_koreksi_modal.sql` |
| 288 | `supabase/migrations/0051_laporan_kas.sql` |
| 289 | `aplikasi/src/layar/laporan/LaporanKas.tsx` |
| 290 | `supabase/migrations/0052_laporan_penjualan.sql` |
| 291 | `aplikasi/src/layar/laporan/LaporanPenjualan.tsx` |
| 292 | `supabase/migrations/0053_laporan_menu.sql` |
| 293 | `aplikasi/src/layar/laporan/LaporanMenu.tsx` |
| 294 | `aplikasi/src/layar/laporan/FormatLaporan.tsx` |
| 295 | `supabase/tes/tengah_malam.sql` |
| 296 | `supabase/tes/golden_laporan.sql` |
| 297 | `prototipe/README.md` |
| 298 | `docs/teknis/BUKU_INSIDEN.md` |
| 299 | `docs/uji/RENCANA_UJI_MANUAL.md` |
| 300 | `alat/periksa-angka-bukti.py` |
| 301 | `supabase/tes/beku_satu_pernyataan.sql` |
| 302 | `supabase/tes/beku_setelah_bayar.sql` |
| 303 | `supabase/tes/buka_shift.sql` |
| 304 | `supabase/tes/cabang_sesi.sql` |
| 305 | `supabase/tes/diskon_cap.sql` |
| 306 | `supabase/tes/diskon_cap_bawaan.sql` |
| 307 | `supabase/tes/diskon_persen.sql` |
| 308 | `supabase/tes/diskon_setuju.sql` |
| 309 | `supabase/tes/hak_fungsi.sql` |
| 310 | `supabase/tes/harga_item.sql` |
| 311 | `supabase/tes/isolasi_lintas_penyewa.sql` |
| 312 | `supabase/tes/isolasi_null_identitas.sql` |
| 313 | `supabase/tes/item_penjaga.sql` |
| 314 | `supabase/tes/izin_efektif_untuk.sql` |
| 315 | `supabase/tes/jejak_pelaku.sql` |
| 316 | `supabase/tes/jejak_pengaturan.sql` |
| 317 | `supabase/tes/jejak_pesanan.sql` |
| 318 | `supabase/tes/kas_pergerakan.sql` |
| 319 | `supabase/tes/koreksi_modal.sql` |
| 320 | `supabase/tes/kupon_wajib_pesanan.sql` |
| 321 | `supabase/tes/laporan_kas.sql` |
| 322 | `supabase/tes/laporan_menu.sql` |
| 323 | `supabase/tes/laporan_pembatalan.sql` |
| 324 | `supabase/tes/laporan_penjualan.sql` |
| 325 | `supabase/tes/meja_penjaga.sql` |
| 326 | `supabase/tes/meja_riwayat.sql` |
| 327 | `supabase/tes/nilai_kerugian.sql` |
| 328 | `supabase/tes/opname_stok.sql` |
| 329 | `supabase/tes/pembayaran_metode.sql` |
| 330 | `supabase/tes/pengingat_shift.sql` |
| 331 | `supabase/tes/penjaga_stok.sql` |
| 332 | `supabase/tes/perangkat_registrasi_tepi.sql` |
| 333 | `supabase/tes/persetujuan_void.sql` |
| 334 | `supabase/tes/pesanan_status_awal.sql` |
| 335 | `supabase/tes/pesanan_tertutup_beku.sql` |
| 336 | `supabase/tes/pin_hierarki.sql` |
| 337 | `supabase/tes/pin_kunci_silang.sql` |
| 338 | `supabase/tes/pin_warisan.sql` |
| 339 | `supabase/tes/saldo_awal_stok.sql` |
| 340 | `supabase/tes/set_stok.sql` |
| 341 | `supabase/tes/status_pesanan.sql` |
| 342 | `supabase/tes/stok_arah.sql` |
| 343 | `supabase/tes/stok_insert_langsung.sql` |
| 344 | `supabase/tes/tujuan_item.sql` |
| 345 | `supabase/tes/tutup_shift.sql` |
| 346 | `supabase/tes/uang_kunci.sql` |
| 347 | `supabase/tes/urutan_rantai_audit.sql` |
| 348 | `supabase/tes/varian_gagal_aman.sql` |
| 349 | `supabase/tes/waktu_peladen.sql` |
| 350 | `alat/bantu_uji_diri.py` |
| 351 | `alat/kirim-laporan.py` |
| 352 | `alat/kirim_laporan.py` |
| 353 | `alat/kontrak_laporan.py` |
| 354 | `alat/mulai-sesi.py` |
| 355 | `alat/periksa-bersih.py` |
| 356 | `alat/periksa-fondasi-independen.py` |
| 357 | `alat/periksa-maraton.py` |
| 358 | `alat/periksa-paritas-ci.py` |
| 359 | `alat/siapkan-pemeriksaan.py` |
| 360 | `alat/uji-kirim-laporan.py` |
| 361 | `alat/uji-mutasi-0012.py` |
| 362 | `alat/uji-mutasi-0014.py` |
| 363 | `alat/uji-mutasi-0016.py` |
| 364 | `alat/uji-mutasi-0017.py` |
| 365 | `alat/uji-mutasi-0018.py` |
| 366 | `alat/uji-mutasi-0021.py` |
| 367 | `alat/uji-mutasi-0032.py` |
| 368 | `alat/uji-mutasi-0033.py` |
| 369 | `alat/uji-mutasi-0035.py` |
| 370 | `alat/uji-mutasi-0036.py` |
| 371 | `alat/uji-mutasi-0037.py` |
| 372 | `alat/uji-mutasi-0038.py` |
| 373 | `alat/uji-mutasi-0040.py` |
| 374 | `alat/uji-mutasi-0045.py` |
| 375 | `alat/uji-mutasi-0046.py` |
| 376 | `alat/uji-mutasi-0047.py` |
| 377 | `alat/uji-mutasi-0048.py` |
| 378 | `alat/uji-mutasi-0049.py` |
| 379 | `alat/uji-mutasi-0050.py` |
| 380 | `alat/uji-mutasi-0051.py` |
| 381 | `alat/uji-mutasi-0052.py` |
| 382 | `alat/uji-mutasi-0053.py` |
| 383 | `alat/uji-mutasi-0054.py` |
...
| `supabase/migrations/0015_audit.sql` | T1-27 (sudah [x] — berkasnya TIDAK ADA: laporkan!) |
| `supabase/migrations/0016_mode_dukungan.sql` | T1-28 (sudah [x] — berkasnya TIDAK ADA: laporkan!) |
...
| `supabase/functions/undang_pegawai/index.ts` | T2-03 (sudah [x] — berkasnya TIDAK ADA: laporkan!) |
| `aplikasi/src/lib/google.ts` | T2-04 (sudah [x] — berkasnya TIDAK ADA: laporkan!) |
| `supabase/functions/pemulihan_pelanggan/index.ts` | T2-05 (sudah [x] — berkasnya TIDAK ADA: laporkan!) |
| `aplikasi/src/hook/useKunciSesi.ts` | T2-09 (sudah [x] — berkasnya TIDAK ADA: laporkan!) |
| `supabase/functions/pembatas_masuk/index.ts` | T2-10 (sudah [x] — berkasnya TIDAK ADA: laporkan!) |
| `supabase/tes/pembatas.sql` | T2-10 (sudah [x] — berkasnya TIDAK ADA: laporkan!) |
| `aplikasi/src/layar/masuk/*.test.ts` | T2-12 (sudah [x] — polanya tidak cocok dengan berkas mana pun: laporkan!) |
| `supabase/tes/peran_masuk.sql` | T2-12 (sudah [x] — berkasnya TIDAK ADA: laporkan!) |
| `aplikasi/src/layar/masuk/Totp.tsx` | T2-13 (sudah [x] — berkasnya TIDAK ADA: laporkan!) |
| `supabase/functions/atur_ulang_mfa/index.ts` | T2-13 (sudah [x] — berkasnya TIDAK ADA: laporkan!) |
| `alat/periksa-fungsi-mfa.py` | T2-13 (sudah [x] — berkasnya TIDAK ADA: laporkan!) |
| `supabase/tes/mfa.sql` | T2-13 (sudah [x] — berkasnya TIDAK ADA: laporkan!) |
| `aplikasi/src/lib/sesi.ts` | T2-14 (sudah [x] — berkasnya TIDAK ADA: laporkan!) |
| `supabase/functions/kode_perangkat/index.ts` | T2-15 (sudah [x] — berkasnya TIDAK ADA: laporkan!) |
| `supabase/tes/masuk_perangkat.sql` | T2-19 (sudah [x] — berkasnya TIDAK ADA: laporkan!) |
| `aplikasi/src/layar/masuk/masuk.test.tsx` | T2-19 (sudah [x] — berkasnya TIDAK ADA: laporkan!) |
| `aplikasi/src/lib/uang.ts` | T3-02 (sudah [x] — berkasnya TIDAK ADA: laporkan!) |
| `aplikasi/src/komponen/CatatanItem.tsx` | T3-03 (sudah [x] — berkasnya TIDAK ADA: laporkan!) |
| `supabase/migrations/0028_simpan_pesanan.sql` | T3-05 |
| `supabase/tes/simpan_pesanan.sql` | T3-05 |
| `aplikasi/src/layar/kasir/PindahMeja.tsx` | T3-06 (sudah [x] — berkasnya TIDAK ADA: laporkan!) |
| `supabase/migrations/0029_pindah_meja.sql` | T3-06 (sudah [x] — berkasnya TIDAK ADA: laporkan!) |
| `supabase/migrations/0030_menu_habis.sql` | T3-07 (sudah [x] — berkasnya TIDAK ADA: laporkan!) |
| `aplikasi/src/layar/kasir/KirimDapur.tsx` | T3-08 (sudah [x] — berkasnya TIDAK ADA: laporkan!) |
| `supabase/migrations/0031_kirim_dapur.sql` | T3-08 (sudah [x] — berkasnya TIDAK ADA: laporkan!) |
| `aplikasi/src/layar/kasir/PeringatanMeja.tsx` | T3-09 |
| `supabase/tes/konflik_meja.sql` | T3-09 |
| `aplikasi/src/hook/usePintasan.ts` | T3-10 (sudah [x] — berkasnya TIDAK ADA: laporkan!) |
| `aplikasi/src/layar/kasir/BatalPesanan.tsx` | T3-13 |
| `supabase/migrations/0032_batal_pra_dapur.sql` | T3-13 |
| `aplikasi/uji/e2e/kasir.spec.ts` | T3-14 (sudah [x] — berkasnya TIDAK ADA: laporkan!) |
| `aplikasi/uji/beban/kasir.test.ts` | T3-16 (sudah [x] — berkasnya TIDAK ADA: laporkan!) |
| `supabase/migrations/0034_status_item.sql` | T4-04 |
| `aplikasi/uji/e2e/dapur.spec.ts` | T4-09 |
| `lib/printer-escpos.ts` | T6-01 (sudah [x] — berkasnya TIDAK ADA: laporkan!) |
| `aplikasi/src/lib/printer/bluetooth.ts` | T6-02 (sudah [x] — berkasnya TIDAK ADA: laporkan!) |
| `aplikasi/src/lib/printer/usb.ts` | T6-03 (sudah [x] — berkasnya TIDAK ADA: laporkan!) |
...
| 61 | T5-06 | VoidItem 8 tes + LayarKasirVoid 7 tes LULUS · aplikasi 62 berkas / 368 tes LULUS · `uji-mutasi-app.mjs` 24/24 MERAH (4 mutasi baru T5-06: alasan tidak wajib, penolakan disulap berhasil, hapus tanpa alasan, item lenyap walau ditolak) · suite SQL 84 LULUS · tsc bersih. |
| 62 | T5-07 | suite SQL **85 LULUS · 0 GAGAL** · `uji-mutasi-0042.py` **4/4 MERAH** · `uji-mutasi-0012.py` **16/16** (M6 dipindah ke `0042` — lihat catatan jebakan) · gerbang & paritas CI LOLOS setelah perintah baru didaftarkan. |
| 63 | T5-08 | `DataPelanggan.test.tsx` **9 tes LULUS** (nomor tidak terkirim tanpa persetujuan; persetujuan tanpa nomor juga tidak cukup; persetujuan ikut sebagai data `setuju: true`; tombol Lewati selalu hidup; melewati tidak mengirim apa pun) · `uji-mutasi-app.mjs` **26/26 MERAH** (2 mutasi baru: kirim tanpa persetujuan, Lewati di |
| 64 | T5-09 | `StrukDigital.test.tsx` **15 tes LULUS** · aplikasi **64 berkas / 392 tes LULUS** · `uji-mutasi-app.mjs` **28/28 MERAH** (2 mutasi baru: tombol Bagikan tampil walau tak didukung, ringkasan mengaku LUNAS padahal belum dibayar) · `tsc` bersih · lint 0 error · format bersih. |
| 65 | T5-10 | `DaftarTransaksi.test.tsx` **13 tes LULUS** · `Struk.test.tsx` **16 tes** tetap hijau · `uji-mutasi-app.mjs` **31/31 MERAH** (3 mutasi baru: tanda SALINAN tidak pernah tampil, pratinjau tanpa tanda salinan, tombol cetak ulang hidup tanpa memilih transaksi). |
| 66 | T5-11 | SQL **86 LULUS · 0 GAGAL** · `DaftarTagihan.test.tsx` **17 tes LULUS** · aplikasi **66 berkas / 422 tes LULUS** · `uji-mutasi-app.mjs` **34/34 MERAH** (3 mutasi baru: umur selalu "baru", sisa mengabaikan uang masuk, umur ditulis menit mentah). |
| 67 | T5-12 | SQL **87 LULUS · 0 GAGAL** · `alat/uji-mutasi-0043.py` **4/4 MERAH** · `DaftarPembatalan.test.tsx` **16 tes LULUS** · aplikasi **68 berkas / 450 tes LULUS** · `uji-mutasi-app.mjs` **42/42 MERAH** · `periksa-gerbang-ci.py` + `periksa-paritas-ci.py` LOLOS. --- ## Fase 6 — Cetak termal ESC/POS (⚠️ ART-7) T-002 |
| 68 | T6-01 | `expos.test.ts` **29 tes LULUS** · `uji-mutasi-app.mjs` **47/47 MERAH** (5 mutasi ESC/POS baru) · aplikasi **69 berkas / 479 tes LULUS** · tsc bersih · lint 0 error. |
| 69 | T6-02 | `profil.test.ts` **20 tes** · `kirim.test.ts` **23 tes** · `PasangPrinter.test.tsx` **14 tes** · 6 mutasi T6-02/T6-03 MERAH. |
| 70 | T6-04 | `struk.test.ts` **22 tes LULUS** · 6 mutasi T6-04 semuanya MERAH. |
| 71 | T6-05 | `tiket.test.ts` **20 tes LULUS** · 6 mutasi T6-05 semuanya MERAH. |
| 72 | T7-12 | Berkas uji SQL `supabase/tes/golden_laporan.sql` membuktikan seluruh angka laporan operasional (`laporan_penjualan`, `laporan_menu`, `laporan_harian`, `laporan_shift`, `laporan_pembatalan`, `laporan_koreksi_modal`) sama persis (|selisih| = 0) dengan hasil hitung langsung dari tabel data mentah transaksi (`pesanan`, `pe |
...
- **Tingkat audit:** AUD-3
- **Commit yang diaudit:** `e7818e2f8c51d4b6503ce6becd1cbc3b7d11be6b` (commit tepat sebelum berkas paket ini dibuat; auditor boleh mencatat commit yang benar-benar ia periksa — tulis apa adanya, jangan dibulatkan ke commit lain)
- **Paket audit:** `docs/uji/paket-audit/AUD-3-2026-09-24.md` (CATATAN: berkas paket ini di-commit SETELAH commit target — ia TIDAK ADA di pohon commit yang kamu audit; jangan mencarinya di sana. Sumber sahmu: repo + cabang sumber + SHA paket + path pada prompt pendek. Temuan audit J F-06)
- **Mode cakupan:** menyeluruh
