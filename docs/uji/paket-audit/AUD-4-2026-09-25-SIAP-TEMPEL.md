...
- **Izin pemilik untuk commit non-hijau:** fase 7 tuntas, 13 temuan AUD-3 ditutup, persiapan audit menyeluruh putaran kedua AUD-4
...
- **Minimum laporan:** ≥18 artefak diperiksa · ≥5 klaim dibantah · ≥15 serangan dijalankan · masing-masing temuan punya perintah bukti
...
- **Jumlah berkas dalam lingkup:** 864
...
- **Berkas paket ini:** `docs/uji/paket-audit/AUD-4-2026-09-25.md` dibuat SETELAH angka di atas dihitung — ia TIDAK masuk hitungan; kalau dihitung pun ia masuk grup `docs/uji`.

**Grup berkas yang wajib kamu sentuh (minimal satu baris bukti per grup):**

| Grup | Isi | Jumlah berkas | Contoh |
|---|---|---|---|
| aplikasi/src | kode aplikasi (layar, komponen, lib, uji) | 220 | `aplikasi/src/App.test.tsx`, `aplikasi/src/App.tsx` … |
...
| alat | perkakas repo (uji SQL, pemeriksa, mekanisme audit) | 102 | `alat/artefak.py`, `alat/audit-independen.py` … |
...
| docs/uji | protokol & laporan uji/audit | 137 | `docs/uji/AUDIT_RIWAYAT.md`, `docs/uji/BERKAS_PENSIUN.md` … |
...
| _log-sesi | log sesi kerja | 15 | `_log-sesi/LOG_SESI_2026-09-15.md`, `_log-sesi/LOG_SESI_2026-09-16.md` … |
...
2. Tulis ringkasan: `Cakupan menyeluruh: X dari 864 berkas` (X = berkas yang benar-benar kamu periksa — angka ini diperiksa mesin).
...
| 125 | `aplikasi/src/bahasa/en.ts` |
| 126 | `aplikasi/src/bahasa/zh.ts` |
| 127 | `aplikasi/src/bahasa/ar.ts` |
| 128 | `aplikasi/src/bahasa/index.tsx` |
| 129 | `aplikasi/alat/periksa-bahasa.py` |
| 130 | `aplikasi/alat/periksa-arah.py` |
| 131 | `aplikasi/src/kontrak/bantuan.ts` |
| 132 | `aplikasi/src/komponen/LembarBantuan.tsx` |
| 133 | `alat/periksa-bantuan.py` |
| 134 | `docs/uji/BUKU_UJI_PEMILIK.md` |
| 135 | `alat/periksa-buku-uji.py` |
| 136 | `alat/tambah-uji.py` |
| 137 | `alat/audit-independen.py` |
| 138 | `alat/periksa-paket.py` |
| 139 | `supabase/migrations/0022_beku_setelah_bayar.sql` |
| 140 | `alat/uji-mutasi-0022.py` |
| 141 | `alat/uji-mutasi-0024.py` |
| 142 | `alat/uji-mutasi-0025.py` |
| 143 | `alat/uji-konkuren-0022.py` |
| 144 | `alat/uji-konkuren-a04.py` |
| 145 | `docs/uji/TEMUAN_LUAR_CAKUPAN_REVIEW.md` |
| 146 | `supabase/migrations/0015_penutup_celah_putaran16.sql` |
| 147 | `alat/lanjut-sesi.py` |
| 148 | `alat/periksa-temuan-audit.py` |
| 149 | `aplikasi/alat/uji-mutasi-app.mjs` |
| 150 | `aplikasi/package-lock.json` |
| 151 | `aplikasi/alat/periksa-node.py` |
| 152 | `alat/uji-edge-pin.mjs` |
| 153 | `alat/artefak.py` |
| 154 | `alat/klasifikasi_mutasi.py` |
| 155 | `alat/ci_target.py` |
| 156 | `docs/uji/BERKAS_PENSIUN.md` |
| 157 | `alat/periksa-kunci-kalibrasi.py` |
| 158 | `alat/periksa-rujukan.py` |
| 159 | `docs/uji/audit/probe-2026-09-20/aud-3-f10-admin-cabang-izin.sql` |
| 160 | `docs/TECH_SPEC.md` |
| 161 | `docs/PRD.md` |
| 162 | `docs/uji/audit/probe-2026-09-20/aud-3-f11-helper-pin.sql` |
| 163 | `supabase/tes/pin_helper_pribadi.sql` |
| 164 | `supabase/tes/nomor_pesanan_kunci.sql` |
| 165 | `alat/uji-mutasi-0015.py` |
| 166 | `docs/uji/audit/probe-2026-09-20/aud-3-f04-status-item.sql` |
| 167 | `supabase/tes/status_item_transisi.sql` |
| 168 | `supabase/tes/uang_peladen.sql` |
| 169 | `docs/uji/audit/probe-2026-09-20/aud-3-f03-f05-f06-uang.sql` |
| 170 | `supabase/tes/metode_bayar_nonaktif.sql` |
| 171 | `supabase/tes/pembatalan_sekali.sql` |
| 172 | `supabase/tes/lifecycle_pesanan.sql` |
| 173 | `docs/uji/audit/LAPORAN_AUD-3_2026-09-19_menyeluruh__01a0bbd2.md` |
| 174 | `docs/uji/audit/probe-2026-09-20/aud-3-f01-f02-uang.sql` |
| 175 | `supabase/tes/nomor_pesanan_isolasi.sql` |
| 176 | `supabase/tes/pin_bukan_oracle.sql` |
| 177 | `supabase/tes/diskon_sesudah_lunas.sql` |
| 178 | `supabase/tes/void_satu_item.sql` |
| 179 | `supabase/tes/pembatalan_penanda_palsu.sql` |
| 180 | `alat/uji-konkuren.py` |
| 181 | `aplikasi/src/lib/auth.ts` |
| 182 | `aplikasi/src/hook/useSesi.ts` |
| 183 | `aplikasi/src/lib/auth.test.ts` |
| 184 | `aplikasi/src/hook/useSesi.test.tsx` |
| 185 | `aplikasi/src/layar/masuk/LayarMasukPegawai.tsx` |
| 186 | `aplikasi/src/layar/masuk/LayarMasukPegawai.test.tsx` |
| 187 | `aplikasi/src/layar/pengaturan/KelolaPegawai.tsx` |
| 188 | `aplikasi/src/layar/pengaturan/KelolaPegawai.test.tsx` |
| 189 | `aplikasi/src/layar/masuk/LayarMasukPelanggan.tsx` |
| 190 | `aplikasi/src/layar/masuk/LayarMasukPelanggan.test.tsx` |
| 191 | `aplikasi/src/layar/masuk/LupaAkses.tsx` |
| 192 | `aplikasi/src/layar/masuk/LupaAkses.test.tsx` |
| 193 | `aplikasi/src/App.tsx` |
| 194 | `aplikasi/src/komponen/Rangka.tsx` |
| 195 | `aplikasi/src/komponen/Navigasi.tsx` |
| 196 | `aplikasi/src/komponen/Rangka.test.tsx` |
| 197 | `aplikasi/src/komponen/Navigasi.test.tsx` |
| 198 | `aplikasi/src/hook/useCabang.ts` |
| 199 | `aplikasi/src/komponen/PemilihCabang.tsx` |
| 200 | `aplikasi/src/hook/useCabang.test.tsx` |
| 201 | `aplikasi/src/komponen/PemilihCabang.test.tsx` |
| 202 | `aplikasi/src/layar/TidakPunyaAkses.tsx` |
| 203 | `aplikasi/src/lib/pesan.ts` |
| 204 | `aplikasi/src/layar/TidakPunyaAkses.test.tsx` |
| 205 | `aplikasi/src/lib/pesan.test.ts` |
| 206 | `aplikasi/src/hook/useKunciOtomatis.ts` |
| 207 | `aplikasi/src/hook/useKunciOtomatis.test.tsx` |
| 208 | `aplikasi/src/main.tsx` |
| 209 | `aplikasi/src/layar/masuk/SkenarioMasukPeran.test.tsx` |
| 210 | `aplikasi/src/layar/masuk/MasukPengelola.tsx` |
| 211 | `aplikasi/src/layar/masuk/MasukPengelola.test.tsx` |
| 212 | `aplikasi/src/layar/masuk/MasukStaf.tsx` |
| 213 | `aplikasi/src/layar/masuk/MasukStaf.test.tsx` |
| 214 | `aplikasi/src/layar/pengaturan/Perangkat.tsx` |
| 215 | `aplikasi/src/layar/pengaturan/Perangkat.test.tsx` |
| 216 | `aplikasi/src/komponen/KunciSekarang.tsx` |
| 217 | `aplikasi/src/komponen/KunciSekarang.test.tsx` |
| 218 | `aplikasi/src/layar/pengaturan/DaftarPerangkat.tsx` |
| 219 | `aplikasi/src/layar/pengaturan/DaftarPerangkat.test.tsx` |
| 220 | `aplikasi/src/layar/kasir/LayarKasir.tsx` |
| 221 | `aplikasi/src/layar/kasir/Katalog.tsx` |
| 222 | `aplikasi/src/layar/kasir/Keranjang.tsx` |
| 223 | `aplikasi/src/layar/kasir/Keranjang.test.tsx` |
| 224 | `aplikasi/src/lib/format.ts` |
| 225 | `aplikasi/src/layar/kasir/PemilihMeja.tsx` |
| 226 | `aplikasi/src/layar/kasir/PemilihMeja.test.tsx` |
| 227 | `aplikasi/src/layar/kasir/DaftarTagihan.tsx` |
| 228 | `supabase/migrations/0035_menu_habis_sumber.sql` |
| 229 | `supabase/migrations/0032_status_item_dapur.sql` |
| 230 | `aplikasi/src/layar/pelayan/LayarPelayan.tsx` |
| 231 | `aplikasi/src/layar/kasir/DaftarPesanan.tsx` |
| 232 | `aplikasi/src/layar/kasir/AlurKasirE2E.test.tsx` |
| 233 | `aplikasi/src/layar/kasir/*.tsx` |
| 234 | `aplikasi/src/komponen/Keadaan*.tsx` |
| 235 | `aplikasi/src/layar/kasir/BebanKasir.test.ts` |
| 236 | `aplikasi/src/layar/dapur/LayarDapur.tsx` |
| 237 | `aplikasi/src/layar/dapur/LayarBar.tsx` |
| 238 | `supabase/migrations/0033_tujuan_item.sql` |
| 239 | `aplikasi/src/layar/dapur/KartuPesanan.tsx` |
| 240 | `supabase/tes/status_item.sql` |
| 241 | `supabase/tes/menu_habis_sumber.sql` |
| 242 | `aplikasi/src/layar/dapur/TombolHabis.tsx` |
| 243 | `aplikasi/src/layar/dapur/Stok.tsx` |
| 244 | `supabase/migrations/0036_stok.sql` |
| 245 | `aplikasi/src/layar/dapur/Opname.tsx` |
| 246 | `supabase/migrations/0037_opname.sql` |
| 247 | `supabase/tes/anti_dobel.sql` |
| 248 | `aplikasi/src/layar/dapur/*.tsx` |
| 249 | `aplikasi/src/layar/kasir/Bayar.tsx` |
| 250 | `aplikasi/src/hook/useBayar.ts` |
| 251 | `aplikasi/src/layar/kasir/Bayar.test.tsx` |
| 252 | `aplikasi/src/hook/useBayar.test.tsx` |
| 253 | `aplikasi/src/layar/kasir/LayarKasirBayar.test.tsx` |
| 254 | `supabase/migrations/0039_bayar_pesanan.sql` |
| 255 | `supabase/tes/bayar_pesanan.sql` |
| 256 | `alat/uji-mutasi-0039.py` |
| 257 | `aplikasi/src/komponen/Struk.tsx` |
| 258 | `aplikasi/src/komponen/Struk.test.tsx` |
| 259 | `supabase/tes/pajak_service.sql` |
| 260 | `supabase/migrations/0019_pesan_diskon_jujur.sql` |
| 261 | `supabase/tes/diskon_tumpuk.sql` |
| 262 | `alat/uji-mutasi-0019.py` |
| 263 | `aplikasi/src/layar/kasir/DiskonManual.tsx` |
| 264 | `aplikasi/src/layar/kasir/DiskonManual.test.tsx` |
| 265 | `supabase/migrations/0041_diskon_pin_atasan.sql` |
| 266 | `supabase/tes/diskon_pin_atasan.sql` |
| 267 | `alat/uji-mutasi-0041.py` |
| 268 | `aplikasi/src/layar/kasir/LayarKasirDiskon.test.tsx` |
| 269 | `aplikasi/src/layar/kasir/VoidItem.tsx` |
| 270 | `aplikasi/src/layar/kasir/VoidItem.test.tsx` |
| 271 | `aplikasi/src/layar/kasir/LayarKasirVoid.test.tsx` |
| 272 | `supabase/migrations/0042_bahan_terbuang_jujur.sql` |
| 273 | `supabase/tes/bahan_terbuang.sql` |
| 274 | `alat/uji-mutasi-0042.py` |
| 275 | `aplikasi/src/layar/kasir/DataPelanggan.tsx` |
| 276 | `aplikasi/src/layar/kasir/DataPelanggan.test.tsx` |
| 277 | `aplikasi/src/komponen/StrukDigital.tsx` |
| 278 | `aplikasi/src/komponen/StrukDigital.test.tsx` |
| 279 | `aplikasi/src/layar/kasir/DaftarTransaksi.tsx` |
| 280 | `supabase/tes/pembayaran_sebagian.sql` |
| 281 | `supabase/migrations/0043_laporan_pembatalan.sql` |
| 282 | `aplikasi/src/layar/laporan/DaftarPembatalan.tsx` |
| 283 | `alat/uji-mutasi-0043.py` |
| 284 | `aplikasi/src/lib/printer/expos.ts` |
| 285 | `aplikasi/src/lib/printer/expos.test.ts` |
| 286 | `aplikasi/src/lib/printer/kirim.ts` |
| 287 | `aplikasi/src/lib/printer/profil.ts` |
| 288 | `aplikasi/src/layar/pengaturan/PasangPrinter.tsx` |
| 289 | `aplikasi/src/lib/printer/struk.ts` |
| 290 | `aplikasi/src/lib/printer/tiket.ts` |
| 291 | `supabase/migrations/0045_buka_shift.sql` |
| 292 | `aplikasi/src/layar/kasir/BukaKas.tsx` |
| 293 | `supabase/migrations/0046_tutup_shift.sql` |
| 294 | `aplikasi/src/layar/kasir/TutupKas.tsx` |
| 295 | `supabase/migrations/0047_kas_pergerakan.sql` |
| 296 | `aplikasi/src/layar/kasir/KasKeluarMasuk.tsx` |
| 297 | `supabase/migrations/0048_wajib_shift.sql` |
| 298 | `supabase/tes/wajib_shift.sql` |
| 299 | `aplikasi/src/komponen/PengingatShift.tsx` |
| 300 | `supabase/migrations/0049_pengingat_shift.sql` |
| 301 | `supabase/migrations/0050_koreksi_modal.sql` |
| 302 | `supabase/migrations/0051_laporan_kas.sql` |
| 303 | `aplikasi/src/layar/laporan/LaporanKas.tsx` |
| 304 | `supabase/migrations/0052_laporan_penjualan.sql` |
| 305 | `aplikasi/src/layar/laporan/LaporanPenjualan.tsx` |
| 306 | `supabase/migrations/0053_laporan_menu.sql` |
| 307 | `aplikasi/src/layar/laporan/LaporanMenu.tsx` |
| 308 | `aplikasi/src/layar/laporan/FormatLaporan.tsx` |
| 309 | `supabase/tes/tengah_malam.sql` |
| 310 | `supabase/tes/golden_laporan.sql` |
| 311 | `prototipe/README.md` |
| 312 | `docs/teknis/BUKU_INSIDEN.md` |
| 313 | `docs/uji/RENCANA_UJI_MANUAL.md` |
| 314 | `alat/periksa-angka-bukti.py` |
| 315 | `supabase/tes/beku_satu_pernyataan.sql` |
| 316 | `supabase/tes/beku_setelah_bayar.sql` |
| 317 | `supabase/tes/buka_shift.sql` |
| 318 | `supabase/tes/cabang_aktif_saya.sql` |
| 319 | `supabase/tes/cabang_sesi.sql` |
| 320 | `supabase/tes/diskon_cap.sql` |
| 321 | `supabase/tes/diskon_cap_bawaan.sql` |
| 322 | `supabase/tes/diskon_persen.sql` |
| 323 | `supabase/tes/diskon_setuju.sql` |
| 324 | `supabase/tes/hak_fungsi.sql` |
| 325 | `supabase/tes/harga_item.sql` |
| 326 | `supabase/tes/isolasi_lintas_penyewa.sql` |
| 327 | `supabase/tes/isolasi_null_identitas.sql` |
| 328 | `supabase/tes/item_penjaga.sql` |
| 329 | `supabase/tes/izin_efektif_untuk.sql` |
| 330 | `supabase/tes/jejak_pelaku.sql` |
| 331 | `supabase/tes/jejak_pengaturan.sql` |
| 332 | `supabase/tes/jejak_pesanan.sql` |
| 333 | `supabase/tes/kas_pergerakan.sql` |
| 334 | `supabase/tes/koreksi_modal.sql` |
| 335 | `supabase/tes/kupon_wajib_pesanan.sql` |
| 336 | `supabase/tes/laporan_kas.sql` |
| 337 | `supabase/tes/laporan_menu.sql` |
| 338 | `supabase/tes/laporan_pembatalan.sql` |
| 339 | `supabase/tes/laporan_penjualan.sql` |
| 340 | `supabase/tes/meja_penjaga.sql` |
| 341 | `supabase/tes/meja_riwayat.sql` |
| 342 | `supabase/tes/nilai_kerugian.sql` |
| 343 | `supabase/tes/opname_stok.sql` |
| 344 | `supabase/tes/pembayaran_audit.sql` |
| 345 | `supabase/tes/pembayaran_metode.sql` |
| 346 | `supabase/tes/pengingat_shift.sql` |
| 347 | `supabase/tes/penjaga_stok.sql` |
| 348 | `supabase/tes/perangkat_registrasi_tepi.sql` |
| 349 | `supabase/tes/percobaan_masuk_tenant.sql` |
| 350 | `supabase/tes/persetujuan_void.sql` |
| 351 | `supabase/tes/pesanan_status_awal.sql` |
| 352 | `supabase/tes/pesanan_tertutup_beku.sql` |
| 353 | `supabase/tes/pin_hierarki.sql` |
| 354 | `supabase/tes/pin_kunci_silang.sql` |
| 355 | `supabase/tes/pin_warisan.sql` |
| 356 | `supabase/tes/saldo_awal_stok.sql` |
| 357 | `supabase/tes/sesi_kedaluwarsa.sql` |
| 358 | `supabase/tes/set_stok.sql` |
| 359 | `supabase/tes/status_pesanan.sql` |
| 360 | `supabase/tes/stok_arah.sql` |
| 361 | `supabase/tes/stok_insert_langsung.sql` |
| 362 | `supabase/tes/truncate_audit_ditolak.sql` |
| 363 | `supabase/tes/tujuan_item.sql` |
| 364 | `supabase/tes/tutup_shift.sql` |
| 365 | `supabase/tes/uang_kunci.sql` |
| 366 | `supabase/tes/urutan_rantai_audit.sql` |
| 367 | `supabase/tes/varian_gagal_aman.sql` |
| 368 | `supabase/tes/verifikasi_pin_perangkat.sql` |
| 369 | `supabase/tes/waktu_peladen.sql` |
| 370 | `alat/bantu_uji_diri.py` |
| 371 | `alat/kirim-laporan.py` |
| 372 | `alat/kirim_laporan.py` |
| 373 | `alat/kontrak_laporan.py` |
| 374 | `alat/mulai-sesi.py` |
| 375 | `alat/periksa-bersih.py` |
| 376 | `alat/periksa-fondasi-independen.py` |
| 377 | `alat/periksa-maraton.py` |
| 378 | `alat/periksa-paritas-ci.py` |
| 379 | `alat/siapkan-pemeriksaan.py` |
| 380 | `alat/uji-kirim-laporan.py` |
| 381 | `alat/uji-mutasi-0012.py` |
| 382 | `alat/uji-mutasi-0014.py` |
| 383 | `alat/uji-mutasi-0016.py` |
| 384 | `alat/uji-mutasi-0017.py` |
| 385 | `alat/uji-mutasi-0018.py` |
| 386 | `alat/uji-mutasi-0021.py` |
| 387 | `alat/uji-mutasi-0032.py` |
| 388 | `alat/uji-mutasi-0033.py` |
| 389 | `alat/uji-mutasi-0035.py` |
| 390 | `alat/uji-mutasi-0036.py` |
| 391 | `alat/uji-mutasi-0037.py` |
| 392 | `alat/uji-mutasi-0038.py` |
| 393 | `alat/uji-mutasi-0040.py` |
| 394 | `alat/uji-mutasi-0045.py` |
| 395 | `alat/uji-mutasi-0046.py` |
| 396 | `alat/uji-mutasi-0047.py` |
| 397 | `alat/uji-mutasi-0048.py` |
| 398 | `alat/uji-mutasi-0049.py` |
| 399 | `alat/uji-mutasi-0050.py` |
| 400 | `alat/uji-mutasi-0051.py` |
| 401 | `alat/uji-mutasi-0052.py` |
| 402 | `alat/uji-mutasi-0053.py` |
| 403 | `alat/uji-mutasi-0054.py` |
| 404 | `alat/uji-mutasi-0056.py` |
| 405 | `alat/uji-mutasi-0057.py` |
| 406 | `alat/uji-mutasi-0058.py` |
| 407 | `alat/uji-mutasi-0059.py` |
| 408 | `alat/uji-mutasi-0060.py` |
| 409 | `alat/uji-mutasi-0061.py` |
...
- **Tingkat audit:** AUD-4
- **Commit yang diaudit:** `804ed86f3464490d5bc6c466b7e268d138b78e5e` (commit tepat sebelum berkas paket ini dibuat; auditor boleh mencatat commit yang benar-benar ia periksa — tulis apa adanya, jangan dibulatkan ke commit lain)
- **Paket audit:** `docs/uji/paket-audit/AUD-4-2026-09-25.md` (CATATAN: berkas paket ini di-commit SETELAH commit target — ia TIDAK ADA di pohon commit yang kamu audit; jangan mencarinya di sana. Sumber sahmu: repo + cabang sumber + SHA paket + path pada prompt pendek. Temuan audit J F-06)
- **Mode cakupan:** menyeluruh
