...
- **Izin pemilik untuk commit non-hijau:** fase 7 tuntas, 13 temuan AUD-3 ditutup, persiapan audit putaran kedua Agent B Antarmuka
...
- **Minimum laporan:** ≥3 artefak diperiksa · ≥5 klaim dibantah · ≥15 serangan dijalankan · masing-masing temuan punya perintah bukti
...
## 0. LINGKUP BIDANG: ANTARMUKA (audit menyeluruh yang DIPERSEMPIT ke berkas bidang ini)

- **Jumlah berkas dalam lingkup:** 185
- **Mode cakupan yang wajib kamu tulis di laporan:** `bidang-antarmuka`
...
- **Berkas paket ini:** `docs/uji/paket-audit/AUD-4-2026-09-25-antarmuka.md` dibuat SETELAH angka di atas dihitung — ia TIDAK masuk hitungan; kalau dihitung pun ia masuk grup `docs/uji`.

**Prefiks berkas bidang antarmuka (definisi mesin):**
- `aplikasi/src/komponen/`
- `aplikasi/src/layar/`
- `aplikasi/src/gaya/`
- `aplikasi/src/bahasa/`
- `aplikasi/alat/`
...
|---|---|---|---|
| aplikasi/src | kode aplikasi (layar, komponen, lib, uji) | 169 | `aplikasi/src/App.tsx`, `aplikasi/src/bahasa/ar.ts` … |
| aplikasi/alat | perkakas pemeriksa aplikasi | 14 | `aplikasi/alat/catat-alamat.mjs`, `aplikasi/alat/cek-supabase.mjs` … |
| docs (fondasi) | PRD, TECH_SPEC, ROADMAP, KEAMANAN, SPESIFIKASI_UI, dll | 2 | `docs/PETA_UI.md`, `docs/SPESIFIKASI_UI.md` |
...
2. Tulis ringkasan: `Cakupan bidang-antarmuka: X dari 185 berkas` (X = berkas yang benar-benar kamu periksa).
...
| # | Berkas |
|---|---|
| 1 | `aplikasi/src/layar/contoh/LayarContoh.tsx` |
| 2 | `aplikasi/alat/periksa-struktur.py` |
| 3 | `aplikasi/src/komponen/*.tsx` |
| 4 | `aplikasi/alat/uji-kontras.py` |
| 5 | `aplikasi/alat/periksa-komponen-env.py` |
| 6 | `aplikasi/alat/cek-supabase.mjs` |
| 7 | `aplikasi/src/komponen/komponen.test.tsx` |
| 8 | `aplikasi/alat/periksa-uji.py` |
| 9 | `docs/SPESIFIKASI_UI.md` |
| 10 | `docs/PETA_UI.md` |
| 11 | `aplikasi/src/komponen/TombolAksi.tsx` |
| 12 | `aplikasi/src/komponen/TombolAksi.test.tsx` |
| 13 | `aplikasi/src/bahasa/id.ts` |
| 14 | `aplikasi/src/bahasa/en.ts` |
| 15 | `aplikasi/src/bahasa/zh.ts` |
| 16 | `aplikasi/src/bahasa/ar.ts` |
| 17 | `aplikasi/src/bahasa/index.tsx` |
| 18 | `aplikasi/alat/periksa-bahasa.py` |
| 19 | `aplikasi/alat/periksa-arah.py` |
| 20 | `aplikasi/src/komponen/LembarBantuan.tsx` |
| 21 | `aplikasi/alat/uji-mutasi-app.mjs` |
| 22 | `aplikasi/alat/periksa-node.py` |
| 23 | `aplikasi/src/layar/masuk/LayarMasukPegawai.tsx` |
| 24 | `aplikasi/src/layar/masuk/LayarMasukPegawai.test.tsx` |
| 25 | `aplikasi/src/layar/pengaturan/KelolaPegawai.tsx` |
| 26 | `aplikasi/src/layar/pengaturan/KelolaPegawai.test.tsx` |
| 27 | `aplikasi/src/layar/masuk/LayarMasukPelanggan.tsx` |
| 28 | `aplikasi/src/layar/masuk/LayarMasukPelanggan.test.tsx` |
| 29 | `aplikasi/src/layar/masuk/LupaAkses.tsx` |
| 30 | `aplikasi/src/layar/masuk/LupaAkses.test.tsx` |
| 31 | `aplikasi/src/App.tsx` |
| 32 | `aplikasi/src/komponen/Rangka.tsx` |
| 33 | `aplikasi/src/komponen/Navigasi.tsx` |
| 34 | `aplikasi/src/komponen/Rangka.test.tsx` |
| 35 | `aplikasi/src/komponen/Navigasi.test.tsx` |
| 36 | `aplikasi/src/komponen/PemilihCabang.tsx` |
| 37 | `aplikasi/src/komponen/PemilihCabang.test.tsx` |
| 38 | `aplikasi/src/layar/TidakPunyaAkses.tsx` |
| 39 | `aplikasi/src/layar/TidakPunyaAkses.test.tsx` |
| 40 | `aplikasi/src/layar/masuk/SkenarioMasukPeran.test.tsx` |
| 41 | `aplikasi/src/layar/masuk/MasukPengelola.tsx` |
| 42 | `aplikasi/src/layar/masuk/MasukPengelola.test.tsx` |
| 43 | `aplikasi/src/layar/masuk/MasukStaf.tsx` |
| 44 | `aplikasi/src/layar/masuk/MasukStaf.test.tsx` |
| 45 | `aplikasi/src/layar/pengaturan/Perangkat.tsx` |
| 46 | `aplikasi/src/layar/pengaturan/Perangkat.test.tsx` |
| 47 | `aplikasi/src/komponen/KunciSekarang.tsx` |
| 48 | `aplikasi/src/komponen/KunciSekarang.test.tsx` |
| 49 | `aplikasi/src/layar/pengaturan/DaftarPerangkat.tsx` |
| 50 | `aplikasi/src/layar/pengaturan/DaftarPerangkat.test.tsx` |
| 51 | `aplikasi/src/layar/kasir/LayarKasir.tsx` |
| 52 | `aplikasi/src/layar/kasir/Katalog.tsx` |
| 53 | `aplikasi/src/layar/kasir/Keranjang.tsx` |
| 54 | `aplikasi/src/layar/kasir/Keranjang.test.tsx` |
| 55 | `aplikasi/src/layar/kasir/PemilihMeja.tsx` |
| 56 | `aplikasi/src/layar/kasir/PemilihMeja.test.tsx` |
| 57 | `aplikasi/src/layar/kasir/DaftarTagihan.tsx` |
| 58 | `aplikasi/src/layar/pelayan/LayarPelayan.tsx` |
| 59 | `aplikasi/src/layar/kasir/DaftarPesanan.tsx` |
| 60 | `aplikasi/src/layar/kasir/AlurKasirE2E.test.tsx` |
| 61 | `aplikasi/src/layar/kasir/*.tsx` |
| 62 | `aplikasi/src/komponen/Keadaan*.tsx` |
| 63 | `aplikasi/src/layar/kasir/BebanKasir.test.ts` |
| 64 | `aplikasi/src/layar/dapur/LayarDapur.tsx` |
| 65 | `aplikasi/src/layar/dapur/LayarBar.tsx` |
| 66 | `aplikasi/src/layar/dapur/KartuPesanan.tsx` |
| 67 | `aplikasi/src/layar/dapur/TombolHabis.tsx` |
| 68 | `aplikasi/src/layar/dapur/Stok.tsx` |
| 69 | `aplikasi/src/layar/dapur/Opname.tsx` |
| 70 | `aplikasi/src/layar/dapur/*.tsx` |
| 71 | `aplikasi/src/layar/kasir/Bayar.tsx` |
| 72 | `aplikasi/src/layar/kasir/Bayar.test.tsx` |
| 73 | `aplikasi/src/layar/kasir/LayarKasirBayar.test.tsx` |
| 74 | `aplikasi/src/komponen/Struk.tsx` |
| 75 | `aplikasi/src/komponen/Struk.test.tsx` |
| 76 | `aplikasi/src/layar/kasir/DiskonManual.tsx` |
| 77 | `aplikasi/src/layar/kasir/DiskonManual.test.tsx` |
| 78 | `aplikasi/src/layar/kasir/LayarKasirDiskon.test.tsx` |
| 79 | `aplikasi/src/layar/kasir/VoidItem.tsx` |
| 80 | `aplikasi/src/layar/kasir/VoidItem.test.tsx` |
| 81 | `aplikasi/src/layar/kasir/LayarKasirVoid.test.tsx` |
| 82 | `aplikasi/src/layar/kasir/DataPelanggan.tsx` |
| 83 | `aplikasi/src/layar/kasir/DataPelanggan.test.tsx` |
| 84 | `aplikasi/src/komponen/StrukDigital.tsx` |
| 85 | `aplikasi/src/komponen/StrukDigital.test.tsx` |
| 86 | `aplikasi/src/layar/kasir/DaftarTransaksi.tsx` |
| 87 | `aplikasi/src/layar/laporan/DaftarPembatalan.tsx` |
| 88 | `aplikasi/src/layar/pengaturan/PasangPrinter.tsx` |
| 89 | `aplikasi/src/layar/kasir/BukaKas.tsx` |
| 90 | `aplikasi/src/layar/kasir/TutupKas.tsx` |
| 91 | `aplikasi/src/layar/kasir/KasKeluarMasuk.tsx` |
| 92 | `aplikasi/src/komponen/PengingatShift.tsx` |
| 93 | `aplikasi/src/layar/laporan/LaporanKas.tsx` |
| 94 | `aplikasi/src/layar/laporan/LaporanPenjualan.tsx` |
| 95 | `aplikasi/src/layar/laporan/LaporanMenu.tsx` |
| 96 | `aplikasi/src/layar/laporan/FormatLaporan.tsx` |
...
- **Tingkat audit:** AUD-4
- **Commit yang diaudit:** `804ed86f3464490d5bc6c466b7e268d138b78e5e` (commit tepat sebelum berkas paket ini dibuat; auditor boleh mencatat commit yang benar-benar ia periksa — tulis apa adanya, jangan dibulatkan ke commit lain)
- **Paket audit:** `docs/uji/paket-audit/AUD-4-2026-09-25-antarmuka.md` (CATATAN: berkas paket ini di-commit SETELAH commit target — ia TIDAK ADA di pohon commit yang kamu audit; jangan mencarinya di sana. Sumber sahmu: repo + cabang sumber + SHA paket + path pada prompt pendek. Temuan audit J F-06)
- **Mode cakupan:** bidang-antarmuka
