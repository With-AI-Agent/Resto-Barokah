...
- **Izin pemilik untuk commit non-hijau:** fase 7 tuntas, 13 temuan AUD-3 ditutup, persiapan audit putaran kedua Agent C Bisnis
...
- **Minimum laporan:** ≥4 artefak diperiksa · ≥5 klaim dibantah · ≥15 serangan dijalankan · masing-masing temuan punya perintah bukti
...
## 0. LINGKUP BIDANG: BISNIS (audit menyeluruh yang DIPERSEMPIT ke berkas bidang ini)

- **Jumlah berkas dalam lingkup:** 240
- **Mode cakupan yang wajib kamu tulis di laporan:** `bidang-bisnis`
...
- **Berkas paket ini:** `docs/uji/paket-audit/AUD-4-2026-09-25-bisnis.md` dibuat SETELAH angka di atas dihitung — ia TIDAK masuk hitungan; kalau dihitung pun ia masuk grup `docs/uji`.

**Prefiks berkas bidang bisnis (definisi mesin):**
- `supabase/migrations/`
- `supabase/tes/`
- `aplikasi/src/layar/kasir/`
- `aplikasi/src/layar/dapur/`
- `aplikasi/src/layar/laporan/`
- `aplikasi/src/lib/printer/`
- `docs/PRD.md`
- `docs/TECH_SPEC.md`
...
|---|---|---|---|
| aplikasi/src | kode aplikasi (layar, komponen, lib, uji) | 74 | `aplikasi/src/layar/dapur/.gitkeep`, `aplikasi/src/layar/dapur/KartuPesanan.test.tsx` … |
...
| docs (fondasi) | PRD, TECH_SPEC, ROADMAP, KEAMANAN, SPESIFIKASI_UI, dll | 2 | `docs/PRD.md`, `docs/TECH_SPEC.md` |
...
2. Tulis ringkasan: `Cakupan bidang-bisnis: X dari 240 berkas` (X = berkas yang benar-benar kamu periksa).
...
| 12 | `supabase/tes/pin.sql` |
| 13 | `supabase/tes/percobaan_pin_perangkat.sql` |
| 14 | `supabase/migrations/0007_katalog.sql` |
| 15 | `supabase/tes/katalog.sql` |
| 16 | `supabase/migrations/0008_meja.sql` |
| 17 | `supabase/tes/meja.sql` |
| 18 | `supabase/migrations/0009_pesanan.sql` |
| 19 | `supabase/tes/pesanan.sql` |
| 20 | `supabase/migrations/0010_pembayaran.sql` |
| 21 | `supabase/tes/pembayaran.sql` |
| 22 | `supabase/migrations/0020_catatan_audit.sql` |
| 23 | `supabase/migrations/0029_audit_kekal_rantai.sql` |
| 24 | `supabase/tes/catatan_audit.sql` |
| 25 | `supabase/tes/audit_rantai.sql` |
| 26 | `supabase/migrations/0014_penutup_celah_putaran13.sql` |
| 27 | `supabase/tes/urutan_uang.sql` |
| 28 | `supabase/tes/gerbang_uang.sql` |
| 29 | `supabase/tes/diskon_voucher.sql` |
| 30 | `supabase/migrations/0011_peran_tunggal.sql` |
| 31 | `supabase/tes/peran_tunggal.sql` |
| 32 | `supabase/tes/kredensial_pin.sql` |
| 33 | `supabase/tes/pin_batas_pasang.sql` |
| 34 | `supabase/migrations/0018_perangkat_terdaftar.sql` |
| 35 | `supabase/migrations/0030_sesi_dan_persetujuan_perangkat.sql` |
| 36 | `supabase/tes/perangkat_registrasi.sql` |
| 37 | `supabase/tes/sesi_dan_perangkat.sql` |
| 38 | `supabase/migrations/0031_mode_dukungan_platform.sql` |
| 39 | `supabase/tes/mode_dukungan.sql` |
| 40 | `supabase/tes/matriks_izin_6_peran.sql` |
| 41 | `supabase/tes/keamanan_fungsi.sql` |
| 42 | `supabase/migrations/0023_acl_fungsi_pemicu.sql` |
| 43 | `supabase/migrations/0027_initplan_policy_rls.sql` |
| 44 | `supabase/migrations/0028_pemulihan_perangkat.sql` |
| 45 | `supabase/tes/pemulihan.sql` |
| 46 | `supabase/migrations/0022_beku_setelah_bayar.sql` |
| 47 | `supabase/migrations/0015_penutup_celah_putaran16.sql` |
| 48 | `docs/TECH_SPEC.md` |
| 49 | `docs/PRD.md` |
| 50 | `supabase/tes/pin_helper_pribadi.sql` |
| 51 | `supabase/tes/nomor_pesanan_kunci.sql` |
| 52 | `supabase/tes/status_item_transisi.sql` |
| 53 | `supabase/tes/uang_peladen.sql` |
| 54 | `supabase/tes/metode_bayar_nonaktif.sql` |
| 55 | `supabase/tes/pembatalan_sekali.sql` |
| 56 | `supabase/tes/lifecycle_pesanan.sql` |
| 57 | `supabase/tes/nomor_pesanan_isolasi.sql` |
| 58 | `supabase/tes/pin_bukan_oracle.sql` |
| 59 | `supabase/tes/diskon_sesudah_lunas.sql` |
| 60 | `supabase/tes/void_satu_item.sql` |
| 61 | `supabase/tes/pembatalan_penanda_palsu.sql` |
| 62 | `aplikasi/src/layar/kasir/LayarKasir.tsx` |
| 63 | `aplikasi/src/layar/kasir/Katalog.tsx` |
| 64 | `aplikasi/src/layar/kasir/Keranjang.tsx` |
| 65 | `aplikasi/src/layar/kasir/Keranjang.test.tsx` |
| 66 | `aplikasi/src/layar/kasir/PemilihMeja.tsx` |
| 67 | `aplikasi/src/layar/kasir/PemilihMeja.test.tsx` |
| 68 | `aplikasi/src/layar/kasir/DaftarTagihan.tsx` |
| 69 | `supabase/migrations/0035_menu_habis_sumber.sql` |
| 70 | `supabase/migrations/0032_status_item_dapur.sql` |
| 71 | `aplikasi/src/layar/kasir/DaftarPesanan.tsx` |
| 72 | `aplikasi/src/layar/kasir/AlurKasirE2E.test.tsx` |
| 73 | `aplikasi/src/layar/kasir/*.tsx` |
| 74 | `aplikasi/src/layar/kasir/BebanKasir.test.ts` |
| 75 | `aplikasi/src/layar/dapur/LayarDapur.tsx` |
| 76 | `aplikasi/src/layar/dapur/LayarBar.tsx` |
| 77 | `supabase/migrations/0033_tujuan_item.sql` |
| 78 | `aplikasi/src/layar/dapur/KartuPesanan.tsx` |
| 79 | `supabase/tes/status_item.sql` |
| 80 | `supabase/tes/menu_habis_sumber.sql` |
| 81 | `aplikasi/src/layar/dapur/TombolHabis.tsx` |
| 82 | `aplikasi/src/layar/dapur/Stok.tsx` |
| 83 | `supabase/migrations/0036_stok.sql` |
| 84 | `aplikasi/src/layar/dapur/Opname.tsx` |
| 85 | `supabase/migrations/0037_opname.sql` |
| 86 | `supabase/tes/anti_dobel.sql` |
| 87 | `aplikasi/src/layar/dapur/*.tsx` |
| 88 | `aplikasi/src/layar/kasir/Bayar.tsx` |
| 89 | `aplikasi/src/layar/kasir/Bayar.test.tsx` |
| 90 | `aplikasi/src/layar/kasir/LayarKasirBayar.test.tsx` |
| 91 | `supabase/migrations/0039_bayar_pesanan.sql` |
| 92 | `supabase/tes/bayar_pesanan.sql` |
| 93 | `supabase/tes/pajak_service.sql` |
| 94 | `supabase/migrations/0019_pesan_diskon_jujur.sql` |
| 95 | `supabase/tes/diskon_tumpuk.sql` |
| 96 | `aplikasi/src/layar/kasir/DiskonManual.tsx` |
| 97 | `aplikasi/src/layar/kasir/DiskonManual.test.tsx` |
| 98 | `supabase/migrations/0041_diskon_pin_atasan.sql` |
| 99 | `supabase/tes/diskon_pin_atasan.sql` |
| 100 | `aplikasi/src/layar/kasir/LayarKasirDiskon.test.tsx` |
| 101 | `aplikasi/src/layar/kasir/VoidItem.tsx` |
| 102 | `aplikasi/src/layar/kasir/VoidItem.test.tsx` |
| 103 | `aplikasi/src/layar/kasir/LayarKasirVoid.test.tsx` |
| 104 | `supabase/migrations/0042_bahan_terbuang_jujur.sql` |
| 105 | `supabase/tes/bahan_terbuang.sql` |
| 106 | `aplikasi/src/layar/kasir/DataPelanggan.tsx` |
| 107 | `aplikasi/src/layar/kasir/DataPelanggan.test.tsx` |
| 108 | `aplikasi/src/layar/kasir/DaftarTransaksi.tsx` |
| 109 | `supabase/tes/pembayaran_sebagian.sql` |
| 110 | `supabase/migrations/0043_laporan_pembatalan.sql` |
| 111 | `aplikasi/src/layar/laporan/DaftarPembatalan.tsx` |
| 112 | `aplikasi/src/lib/printer/expos.ts` |
| 113 | `aplikasi/src/lib/printer/expos.test.ts` |
| 114 | `aplikasi/src/lib/printer/kirim.ts` |
| 115 | `aplikasi/src/lib/printer/profil.ts` |
| 116 | `aplikasi/src/lib/printer/struk.ts` |
| 117 | `aplikasi/src/lib/printer/tiket.ts` |
| 118 | `supabase/migrations/0045_buka_shift.sql` |
| 119 | `aplikasi/src/layar/kasir/BukaKas.tsx` |
| 120 | `supabase/migrations/0046_tutup_shift.sql` |
| 121 | `aplikasi/src/layar/kasir/TutupKas.tsx` |
| 122 | `supabase/migrations/0047_kas_pergerakan.sql` |
| 123 | `aplikasi/src/layar/kasir/KasKeluarMasuk.tsx` |
| 124 | `supabase/migrations/0048_wajib_shift.sql` |
| 125 | `supabase/tes/wajib_shift.sql` |
| 126 | `supabase/migrations/0049_pengingat_shift.sql` |
| 127 | `supabase/migrations/0050_koreksi_modal.sql` |
| 128 | `supabase/migrations/0051_laporan_kas.sql` |
| 129 | `aplikasi/src/layar/laporan/LaporanKas.tsx` |
| 130 | `supabase/migrations/0052_laporan_penjualan.sql` |
| 131 | `aplikasi/src/layar/laporan/LaporanPenjualan.tsx` |
| 132 | `supabase/migrations/0053_laporan_menu.sql` |
| 133 | `aplikasi/src/layar/laporan/LaporanMenu.tsx` |
| 134 | `aplikasi/src/layar/laporan/FormatLaporan.tsx` |
| 135 | `supabase/tes/tengah_malam.sql` |
| 136 | `supabase/tes/golden_laporan.sql` |
| 137 | `supabase/tes/beku_satu_pernyataan.sql` |
| 138 | `supabase/tes/beku_setelah_bayar.sql` |
| 139 | `supabase/tes/buka_shift.sql` |
| 140 | `supabase/tes/cabang_aktif_saya.sql` |
| 141 | `supabase/tes/cabang_sesi.sql` |
| 142 | `supabase/tes/diskon_cap.sql` |
| 143 | `supabase/tes/diskon_cap_bawaan.sql` |
| 144 | `supabase/tes/diskon_persen.sql` |
| 145 | `supabase/tes/diskon_setuju.sql` |
| 146 | `supabase/tes/hak_fungsi.sql` |
| 147 | `supabase/tes/harga_item.sql` |
| 148 | `supabase/tes/isolasi_lintas_penyewa.sql` |
| 149 | `supabase/tes/isolasi_null_identitas.sql` |
| 150 | `supabase/tes/item_penjaga.sql` |
| 151 | `supabase/tes/izin_efektif_untuk.sql` |
| 152 | `supabase/tes/jejak_pelaku.sql` |
| 153 | `supabase/tes/jejak_pengaturan.sql` |
| 154 | `supabase/tes/jejak_pesanan.sql` |
| 155 | `supabase/tes/kas_pergerakan.sql` |
| 156 | `supabase/tes/koreksi_modal.sql` |
| 157 | `supabase/tes/kupon_wajib_pesanan.sql` |
| 158 | `supabase/tes/laporan_kas.sql` |
| 159 | `supabase/tes/laporan_menu.sql` |
| 160 | `supabase/tes/laporan_pembatalan.sql` |
| 161 | `supabase/tes/laporan_penjualan.sql` |
| 162 | `supabase/tes/meja_penjaga.sql` |
| 163 | `supabase/tes/meja_riwayat.sql` |
| 164 | `supabase/tes/nilai_kerugian.sql` |
| 165 | `supabase/tes/opname_stok.sql` |
| 166 | `supabase/tes/pembayaran_audit.sql` |
| 167 | `supabase/tes/pembayaran_metode.sql` |
| 168 | `supabase/tes/pengingat_shift.sql` |
| 169 | `supabase/tes/penjaga_stok.sql` |
| 170 | `supabase/tes/perangkat_registrasi_tepi.sql` |
| 171 | `supabase/tes/percobaan_masuk_tenant.sql` |
| 172 | `supabase/tes/persetujuan_void.sql` |
| 173 | `supabase/tes/pesanan_status_awal.sql` |
| 174 | `supabase/tes/pesanan_tertutup_beku.sql` |
| 175 | `supabase/tes/pin_hierarki.sql` |
| 176 | `supabase/tes/pin_kunci_silang.sql` |
| 177 | `supabase/tes/pin_warisan.sql` |
| 178 | `supabase/tes/saldo_awal_stok.sql` |
| 179 | `supabase/tes/sesi_kedaluwarsa.sql` |
| 180 | `supabase/tes/set_stok.sql` |
| 181 | `supabase/tes/status_pesanan.sql` |
| 182 | `supabase/tes/stok_arah.sql` |
| 183 | `supabase/tes/stok_insert_langsung.sql` |
| 184 | `supabase/tes/truncate_audit_ditolak.sql` |
| 185 | `supabase/tes/tujuan_item.sql` |
| 186 | `supabase/tes/tutup_shift.sql` |
| 187 | `supabase/tes/uang_kunci.sql` |
| 188 | `supabase/tes/urutan_rantai_audit.sql` |
| 189 | `supabase/tes/varian_gagal_aman.sql` |
| 190 | `supabase/tes/verifikasi_pin_perangkat.sql` |
| 191 | `supabase/tes/waktu_peladen.sql` |
