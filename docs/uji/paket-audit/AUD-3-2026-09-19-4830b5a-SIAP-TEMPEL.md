...
- **Tingkat audit:** AUD-3
- **Commit yang diaudit:** `4830b5a4f876744ecb37e2f4495c6df234376752` (commit tepat sebelum berkas paket ini dibuat; auditor boleh mencatat commit yang benar-benar ia periksa — tulis apa adanya, jangan dibulatkan ke commit lain)
...
Paket ini menargetkan commit **`4830b5a4f876744ecb37e2f4495c6df234376752`** pada cabang **`arena/01a0b7d1-resto-barokah`**. **Cabang/base apa pun yang Lee pilih tidak masalah** —
...
> git checkout --detach 4830b5a4f876744ecb37e2f4495c6df234376752
> ```
...
git cat-file -e 4830b5a4f876744ecb37e2f4495c6df234376752            # apakah commit target ada di repo ini?
```

- **Sama** (`HEAD` = `4830b5a4f876744ecb37e2f4495c6df234376752`) → langsung lanjut.
- **Berbeda tetapi commit target ada** → pindah hanya-baca lalu lanjut (aman, tidak mengubah apa pun):
  `git fetch origin && git checkout --detach 4830b5a4f876744ecb37e2f4495c6df234376752`
...
- **Jumlah berkas dalam lingkup:** 480
...
| docs/uji | protokol & laporan uji/audit | 88 | `docs/uji/AUDIT_RIWAYAT.md`, `docs/uji/BERKAS_PENSIUN.md` … |
...
2. Tulis ringkasan: `Cakupan menyeluruh: X dari 480 berkas` (X = berkas yang benar-benar kamu periksa; angka ini diperiksa mesin).
