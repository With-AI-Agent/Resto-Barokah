...
- **Tingkat audit:** AUD-3
- **Commit yang diaudit:** `52e22fc3b06e75e2e2eaf5740d707671d2115a77` (commit tepat sebelum berkas paket ini dibuat; auditor boleh mencatat commit yang benar-benar ia periksa — tulis apa adanya, jangan dibulatkan ke commit lain)
...
Paket ini menargetkan commit **`52e22fc3b06e75e2e2eaf5740d707671d2115a77`**. **Cabang/base apa pun yang Lee pilih tidak masalah** — yang menentukan adalah commit-nya.
...
git cat-file -e 52e22fc3b06e75e2e2eaf5740d707671d2115a77            # apakah commit target ada di repo ini?
```

- **Sama** (`HEAD` = `52e22fc3b06e75e2e2eaf5740d707671d2115a77`) → langsung lanjut.
- **Berbeda tetapi commit target ada** → pindah hanya-baca lalu lanjut (aman, tidak mengubah apa pun):
  `git fetch origin && git checkout --detach 52e22fc3b06e75e2e2eaf5740d707671d2115a77`
...
- **Jumlah berkas dalam lingkup:** 432
...
| docs/uji | protokol & laporan uji/audit | 63 | `docs/uji/AUDIT_RIWAYAT.md`, `docs/uji/BUKU_UJI_PEMILIK.md` … |
| docs/teknis | catatan teknis & Buku Insiden | 6 | `docs/teknis/BUKU_INSIDEN.md`, `docs/teknis/DISKUSI_TAHAP4_ATURAN_KERJA.md` … |
| docs/ops | panduan operasional | 4 | `docs/ops/DAFTAR_KUNCI_PEMILIK.template.md`, `docs/ops/SIAP-LANJUT.md` … |
...
2. Tulis ringkasan: `Cakupan menyeluruh: X dari 432 berkas` (X = berkas yang benar-benar kamu periksa; angka ini diperiksa mesin).
