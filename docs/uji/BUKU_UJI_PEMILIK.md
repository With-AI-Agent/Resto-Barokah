...
|---|---|---|---|---|---|
| P-03 | **Mengisi lembar kunci & akun** — tempat kamu menuliskan hal yang harus dikumpulkan (alamat proyek, kunci, akun layanan) | 1) Buka `docs/ops/DAFTAR_KUNCI_PEMILIK.local.md` 2) Isi kolom "Nilai" untuk baris yang sudah kamu dapat 3) **Jangan tempel nilai rahasia di chat** — cukup tulis di berkas itu | Lembar terisi rapi; berkas ini tidak pernah masuk Git (dijaga `alat/periksa-rahasia.py`) |  |  |
