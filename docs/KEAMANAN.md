...
|---|---|---|
| **Kasir · Pelayan · Dapur** | **Perangkat terdaftar + PIN 6 digit** | Satset (2 detik). Tanpa perangkat terdaftar, PIN tidak menghasilkan sesi yang bisa dipakai _(inti pagar `perangkat_id` + kunci terverifikasi mendarat di T1-24/0018; sisa kode pendaftaran, persetujuan pasangan, sesi, dan MFA tetap berada di tugasnya masing-masing — lihat F F-08)._ PIN = PIN persetujuan (satu rahasia). |
