...
| T-014 | 2026-09-17 | **Region proyek Supabase** (usul agent: Singapore) | Tidak menghambat kerja: pengaruh utama lokasi data pelanggan & dasar transfer UU PDP | Usul sementara: Singapore | **saat T0-08 (pemilik membuat proyek Supabase)** | pemilik | [ ] terbuka |
