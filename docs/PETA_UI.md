...
| `pengaturan.atur_akses_cabang` | Atur Penugasan Staf | `pengaturan` | owner_pusat, admin_cabang | `kelola_pegawai` | `set_akses_cabang` | `tulis` | - | Ya | `uji_pengaturan_atur_akses_cabang` |
...
| `pengaturan.simpan_cabang` | Simpan Cabang | `pengaturan` | owner_pusat, admin_cabang | `atur_pengaturan` | `simpan_cabang` | `tulis` | - | Ya | `uji_pengaturan_simpan_cabang` |
...
| `pengaturan.tambah_cabang` | Tambah Cabang | `pengaturan` | owner_pusat | `atur_pengaturan` | `tambah_cabang` | `tulis` | - | Ya | `uji_pengaturan_tambah_cabang` |
