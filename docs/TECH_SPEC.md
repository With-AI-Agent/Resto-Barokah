...
| `menu_habis_riwayat` | `id`, `penyewa_id`, `menu_item_id`, `cabang_id`, `habis`, `pelaku_id`, `waktu` | Jejak hanya-tambah penanda menu habis — siapa & kapan (T4-05, 0035); sumber kebenaran tetap `menu_cabang.habis` |
