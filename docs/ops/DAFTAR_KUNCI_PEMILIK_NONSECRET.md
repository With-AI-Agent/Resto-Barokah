...
| A-04 | Akun Cloudflare (email yang dipakai)          | cloudflare.com → My Profile                                | TIDAK    |       | f***@gmail.com *(disamarkan — repo publik, temuan K F-06; Lee tahu nilainya)*                                                                           |
| A-05 | Nama akun Cloudflare (Account ID)             | Cloudflare → Workers & Pages → Account ID                  | TIDAK    |       | 2b55bd03207235e421de6ec18837b654                                                                  |
| A-06 | Akun email pengirim (Google) untuk notifikasi | console.cloud.google.com                                   | TIDAK    |       | f***@gmail.com *(disamarkan — repo publik, temuan K F-06; Lee tahu nilainya)*                                                                           |
