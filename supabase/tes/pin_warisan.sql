...
select uji.sama(
  (public.verifikasi_pin('90000000-0000-0000-0000-000000000005', '1234')).pesan,
...
select uji.sama(public.simpan_pin('482619', '1234'), 'PIN tersimpan.',
                'PR-09: naik kelas 4→6 angka berhasil dengan PIN lama yang benar');
select uji.sama(
  (public.verifikasi_pin('90000000-0000-0000-0000-000000000005', '482619')).berhasil,
...
select uji.klaim('90000000-0000-0000-0000-000000000005');
set local role authenticated;
select uji.sama(public.simpan_pin('482619', '9999'),
...
select uji.klaim('90000000-0000-0000-0000-000000000005');
set local role authenticated;
select public.simpan_pin('482619', '9999');
select public.simpan_pin('482619', '9999');
select public.simpan_pin('482619', '9999');
select public.simpan_pin('482619', '9999');
select uji.sama(public.simpan_pin('482619', '1234') like 'PIN lama salah. Coba lagi setelah %',
