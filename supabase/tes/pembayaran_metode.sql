...
select uji.harap_gagal(
  $$insert into public.pembayaran (pesanan_id, kasir_id, metode_id, metode_nama_saat_itu, jenis_saat_itu,
                                   jumlah, diterima, kunci_idempoten)
      values ('eeee0000-0000-0000-0000-000000000010','90000000-0000-0000-0000-000000000004',
              null, 'Transfer BCA (karangan)', 'tunai', 10000, 20000, 'metode-karangan')$$,
  'pembayaran TANPA metode_id ditolak — label metode tidak boleh dikarang dari perangkat'
);
