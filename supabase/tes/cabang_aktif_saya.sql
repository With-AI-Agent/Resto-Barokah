...
--    boleh melihat cabang B1, BUKAN cabang A1/A2. Kalau filter `penyewa_id`
--    dihapus dari helper, fungsi akan mengembalikan cabang A1 (lebih dulu
--    dibuat_pada) — pagar MITIGATION uji ini.
...
-- 8. Oracle dicek: kalau filter penyewa dihapus, hasil fungsi akan
--    menjadi cabang A1 (lebih dulu dibuat_pada) — itu AKAN menjadi merah
--    di uji 7. (Kontrol mitigasi agar pagar bisa dibuktikan tajam.)
--    Bagian ini bukan pengujian terpisah, melainkan jaminan bahwa uji 7
--    menguji perilaku pagar (filter penyewa) bukan hal lain.
